(self["webpackJsonpCheckout"] = self["webpackJsonpCheckout"] || []).push([["packages_core_src_app_cart_Redeemable_tsx-packages_core_src_app_cart_mapToRedeemableProps_ts--8e9068"],{
...
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/form/contexts/FormContext.tsx");
/* harmony import */ var _ui_alert__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../ui/alert */ "./packages/core/src/app/ui/alert/Alert.tsx");
/* harmony import */ var _ui_button__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../ui/button */ "./packages/core/src/app/ui/button/Button.tsx");
/* harmony import */ var _ui_form__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../ui/form */ "./packages/core/src/app/ui/form/FormField.tsx");
/* harmony import */ var _ui_form__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../ui/form */ "./packages/core/src/app/ui/form/TextInput.tsx");
/* harmony import */ var _ui_form__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../ui/form */ "./packages/core/src/app/ui/form/Label.tsx");
/* harmony import */ var _ui_toggle__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../ui/toggle */ "./packages/core/src/app/ui/toggle/Toggle.tsx");
...
const Redeemable = (_a) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ui_toggle__WEBPACK_IMPORTED_MODULE_16__["default"], { openByDefault: !shouldCollapseCouponCode }, ({ toggle, isOpen }) => (react__WEBPACK_IMPORTED_MODULE_4___default().createElement((react__WEBPACK_IMPORTED_MODULE_4___default().Fragment), null,
...
const RedeemableForm = ({ appliedRedeemableError, isApplyingRedeemable, clearError = lodash__WEBPACK_IMPORTED_MODULE_3__.noop, submitForm, language }) => {
    ...
    const renderLabel = (0,react__WEBPACK_IMPORTED_MODULE_4__.useCallback)((name) => (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ui_form__WEBPACK_IMPORTED_MODULE_15__["default"], { hidden: true, htmlFor: name },
    ...
    const renderInput = (0,react__WEBPACK_IMPORTED_MODULE_4__.useCallback)((setSubmitted) => ({ field }) => (react__WEBPACK_IMPORTED_MODULE_4___default().createElement((react__WEBPACK_IMPORTED_MODULE_4___default().Fragment), null,
        appliedRedeemableError &&
            ...
            appliedRedeemableError.errors[0] && (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ui_alert__WEBPACK_IMPORTED_MODULE_11__["default"], { type: _ui_alert__WEBPACK_IMPORTED_MODULE_11__.AlertType.Error }, renderErrorMessage(appliedRedeemableError.errors[0].code, appliedRedeemableError.errors[0].message))),
        react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", { className: "form-prefixPostfix" },
            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ui_form__WEBPACK_IMPORTED_MODULE_14__["default"], Object.assign({}, field, { "aria-label": language.translate('redeemable.code_label'), className: "form-input optimizedCheckout-form-input", onKeyDown: handleKeyDown(setSubmitted), testId: "redeemableEntry-input" })),
            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ui_button__WEBPACK_IMPORTED_MODULE_12__["default"], { className: "form-prefixPostfix-button--postfix body-bold", disabled: isSubmittingOrder(), id: "applyRedeemableButton", isLoading: isApplyingRedeemable, onClick: handleSubmit(setSubmitted), testId: "redeemableEntry-submit", variant: _ui_button__WEBPACK_IMPORTED_MODULE_12__.ButtonVariant.Secondary },
    ...
    const renderContent = (0,react__WEBPACK_IMPORTED_MODULE_4__.useCallback)((0,_bigcommerce_memoize__WEBPACK_IMPORTED_MODULE_1__.memoizeOne)(({ setSubmitted }) => (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_ui_form__WEBPACK_IMPORTED_MODULE_13__["default"], { input: renderInput(setSubmitted), label: renderLabel, name: "redeemableCode" }))), [renderLabel, renderInput]);
    return (react__WEBPACK_IMPORTED_MODULE_4___default().createElement("fieldset", { className: "form-fieldset redeemable-entry" },
        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_10__.FormProvider, null, renderContent)));
};
...
//# sourceMappingURL=packages_core_src_app_cart_Redeemable_tsx-packages_core_src_app_cart_mapToRedeemableProps_ts--8e9068.js.map