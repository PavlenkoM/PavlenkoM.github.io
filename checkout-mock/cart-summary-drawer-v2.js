...
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/icon/IconChevronUp.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/icon/IconChevronDown.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/icon/IconArrowLeft.tsx");
...
/* harmony import */ var _order_OrderSummary__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../order/OrderSummary */ "./packages/core/src/app/order/OrderSummary.tsx");
/* harmony import */ var _EditLink__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./EditLink */ "./packages/core/src/app/cart/EditLink.tsx");
/* harmony import */ var _mapToCartSummaryProps__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./mapToCartSummaryProps */ "./packages/core/src/app/cart/mapToCartSummaryProps.ts");
/* harmony import */ var _withRedeemable__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./withRedeemable */ "./packages/core/src/app/cart/withRedeemable.tsx");
...
const CartSummaryDrawerV2 = ({ isMultiShippingMode }) => {
    ...
    const props = (0,_mapToCartSummaryProps__WEBPACK_IMPORTED_MODULE_10__["default"])(checkoutContext);
    if (!props) {
        return null;
    }
    const { cartUrl, isBuyNowCart, checkout } = props;
    const headerLink = isBuyNowCart ? null : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_EditLink__WEBPACK_IMPORTED_MODULE_9__["default"], { isMultiShippingMode: isMultiShippingMode, label: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "cart.go_to_cart_action" }), url: cartUrl }));
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "cart-summary-drawer" },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { "aria-expanded": isExpanded, className: "cart-summary-toggle", onClick: () => setIsExpanded(!isExpanded) },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: 'body-regular' },
                ...
                isExpanded ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_4__["default"], null) : react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_5__["default"], null)),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: "sub-header" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_currency__WEBPACK_IMPORTED_MODULE_7__["default"], { amount: checkout.outstandingBalance }))),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_3__.CollapseCSSTransition, { isVisible: isExpanded, nodeRef: nodeRef },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { ref: nodeRef }, ((0,_withRedeemable__WEBPACK_IMPORTED_MODULE_11__["default"])(_order_OrderSummary__WEBPACK_IMPORTED_MODULE_8__["default"])(Object.assign(Object.assign({}, props), { headerLink: null, showHeader: false })))))));
};
