...
const NewOrderSummarySubtotals = ({ fees, giftWrappingAmount, handlingAmount, isTaxIncluded, storeCreditAmount, taxes, isOrderConfirmation = false, }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", { className: "subtotals-with-multi-coupon cart-section optimizedCheckout-orderSummary-cartSection" },
            ...
            !isTaxIncluded &&
                (taxes || []).map((tax, index) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_order__WEBPACK_IMPORTED_MODULE_6__["default"], { amount: tax.amount, key: index, label: tax.name, testId: "cart-taxes" }))),
...
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/icon/IconRemoveCoupon.tsx");
...
const CouponForm = () => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement((react__WEBPACK_IMPORTED_MODULE_1___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { className: "coupon-form", "data-test": "redeemable-collapsable", id: "coupon-form-collapsable" },
            ...
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_5__["default"], { className: "coupon-button body-bold", disabled: isCouponFormDisabled, id: "applyRedeemableButton", isLoading: isApplyingCouponOrGiftCertificate, onClick: submitForm, testId: "redeemableEntry-submit", variant: _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_5__.ButtonVariant.Secondary },
        ...
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { className: "applied-coupons-list" },
            Boolean(couponError) && (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_6__["default"], { additionalClassName: "no-padding", type: _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_6__.AlertType.Error },
...
/* harmony import */ var _bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @bigcommerce/checkout/locale */ "./packages/locale/src/TranslatedString.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/animation/collapse/CollapseCSSTransition.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/responsive/isSmallScreen.ts");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/icon/IconChevronUp.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/icon/IconChevronDown.tsx");
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", { className: "cart-section-heading optimizedCheckout-contentPrimary body-medium", "data-test": "cart-count-total" },
        ...
        shouldDisplayBackorderDetails && backorderCount > 0 && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { className: "cart-backorder-link", "data-test": "cart-backorder-link", href: "#", onClick: (0,_bigcommerce_checkout_dom_utils__WEBPACK_IMPORTED_MODULE_3__["default"])(() => setShowBackorderDetails((prev) => !prev)) },
            ...
            !showBackorderDetails && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_8__["default"], null)))))));
};
const ProductList = ({ items, isExpanded, collapsedLimit, showBackorderDetails, }) => {
    const summaryItems = [
        ...items.physicalItems
            ...
            .map((item) => (0,_mapFromPhysical__WEBPACK_IMPORTED_MODULE_14__["default"])(item)),
        ...items.giftCertificates.slice().map(_mapFromGiftCertificate__WEBPACK_IMPORTED_MODULE_13__["default"]),
        ...items.digitalItems
            .slice()
            .sort((item) => item.variantId)
            .map(_mapFromDigital__WEBPACK_IMPORTED_MODULE_12__["default"]),
...
const CartActions = ({ isExpanded, onToggle, }) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "cart-actions" },
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: "button button--tertiary button--tiny optimizedCheckout-buttonSecondary sub-text-medium", onClick: onToggle, type: "button" }, isExpanded ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_7__["default"], null))) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
...
const OrderSummaryItems = ({ displayLineItemsCount = true, items, }) => {
    ...
    const collapsedLimit = (0,_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_6__.isSmallScreen)()
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        displayLineItemsCount && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ItemCount, { items: items, nonBundledItems: nonBundledItems, setShowBackorderDetails: setShowBackorderDetails, showBackorderDetails: showBackorderDetails })),
...
const OrderSummarySubtotals = ({ discountAmount, isTaxIncluded, giftCertificates, taxes, fees, giftWrappingAmount, shippingAmount, shippingAmountBeforeDiscount, subtotalAmount, handlingAmount, storeCreditAmount, coupons, onRemovedGiftCertificate, onRemovedCoupon, }) => {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        ...
        !isTaxIncluded &&
            (taxes || []).map((tax, index) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_OrderSummaryPrice__WEBPACK_IMPORTED_MODULE_4__["default"], { amount: tax.amount, key: index, label: tax.name, testId: "cart-taxes" }))),
...
function mapFromDigital(item) {
    return Object.assign({ id: item.id, quantity: item.quantity, amount: item.extendedComparisonPrice, amountAfterDiscount: item.extendedSalePrice, name: item.name, image: (0,_getOrderSummaryItemImage__WEBPACK_IMPORTED_MODULE_2__["default"])(item), productOptions: [
            ...(item.options || []).map((option) => ({
                testId: 'cart-item-product-option',
                content: `${option.name} ${option.value}`,
            })),
            getDigitalItemDescription(item),
        ] }, (0,_mapBackorderDetails__WEBPACK_IMPORTED_MODULE_3__.mapBackorderDetails)(item));
}
...
function mapFromPhysical(item) {
    return Object.assign({ id: item.id, quantity: item.quantity, amount: item.extendedComparisonPrice, amountAfterDiscount: item.extendedSalePrice, name: item.name, image: (0,_getOrderSummaryItemImage__WEBPACK_IMPORTED_MODULE_0__["default"])(item), description: item.giftWrapping ? item.giftWrapping.name : undefined, productOptions: (item.options || []).map((option) => ({
            testId: 'cart-item-product-option',
            content: `${option.name} ${option.value}`,
        })) }, (0,_mapBackorderDetails__WEBPACK_IMPORTED_MODULE_1__.mapBackorderDetails)(item));
}
