...
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/icon/IconRemove.tsx");
        ...
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { className: "redeemable" },
            ...
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { className: "redeemable-column redeemable-actions" },
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement("button", { className: classnames__WEBPACK_IMPORTED_MODULE_0___default()('redeemable-remove', { 'is-loading': isRemoving }), "data-test": "redeemable-remove", disabled: isRemoving, onClick: onRemove, type: "button" },
                    react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_3__["default"], null)))))));
...
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/toggle/Toggle.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/form/Label/Label.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/alert/Alert.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/form/TextInput/TextInput.tsx");
...
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/form/FormField/FormField.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/form/contexts/FormContext.tsx");
/* harmony import */ var _AppliedRedeemables__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./AppliedRedeemables */ "./packages/core/src/app/cart/AppliedRedeemables.tsx");
...
const Redeemable = (_a) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_10__.Toggle, { openByDefault: !shouldCollapseCouponCode }, ({ toggle, isOpen }) => (react__WEBPACK_IMPORTED_MODULE_4___default().createElement((react__WEBPACK_IMPORTED_MODULE_4___default().Fragment), null,
        shouldCollapseCouponCode && (react__WEBPACK_IMPORTED_MODULE_4___default().createElement("a", { "aria-controls": "redeemable-collapsable", "aria-expanded": isOpen, className: "redeemable-label body-cta", "data-test": "redeemable-label", href: "#", onClick: (0,_bigcommerce_checkout_dom_utils__WEBPACK_IMPORTED_MODULE_7__["default"])(toggle) },
            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_8__["default"], { id: "redeemable.toggle_action" }))),
        !shouldCollapseCouponCode && (react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", { className: "redeemable-label body-cta" },
            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_8__["default"], { id: "redeemable.toggle_action" }))),
        (isOpen || !shouldCollapseCouponCode) && (react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", { "data-test": "redeemable-collapsable", id: "redeemable-collapsable" },
            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(RedeemableForm, Object.assign({}, formProps)),
            showAppliedRedeemables && react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_AppliedRedeemables__WEBPACK_IMPORTED_MODULE_17__["default"], Object.assign({}, formProps))))))));
};
const RedeemableForm = ({ appliedRedeemableError, isApplyingRedeemable, clearError = lodash__WEBPACK_IMPORTED_MODULE_3__.noop, submitForm, language }) => {
    const { checkoutState: { statuses: { isSubmittingOrder }, }, } = (0,_bigcommerce_checkout_contexts__WEBPACK_IMPORTED_MODULE_6__.useCheckout)();
    ...
    const handleKeyDown = (0,react__WEBPACK_IMPORTED_MODULE_4__.useCallback)((0,_bigcommerce_memoize__WEBPACK_IMPORTED_MODULE_1__.memoizeOne)((setSubmitted) => (event) => {
    ...
    const handleSubmit = (0,react__WEBPACK_IMPORTED_MODULE_4__.useCallback)((0,_bigcommerce_memoize__WEBPACK_IMPORTED_MODULE_1__.memoizeOne)((setSubmitted) => () => {
        handleSubmitForm(setSubmitted);
    }), []);
    const renderLabel = (0,react__WEBPACK_IMPORTED_MODULE_4__.useCallback)((name) => (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_11__["default"], { hidden: true, htmlFor: name },
        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_8__["default"], { id: "redeemable.code_label" }))), []);
    const renderErrorMessage = (0,react__WEBPACK_IMPORTED_MODULE_4__.useCallback)((errorCode, errorMessage) => {
        switch (errorCode) {
            case 'min_purchase':
                return react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_8__["default"], { id: "redeemable.coupon_min_order_total" });
            case 'not_applicable':
                return react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_8__["default"], { id: "redeemable.coupon_location_error" });
            default:
                return errorMessage || react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_8__["default"], { id: "redeemable.code_invalid_error" });
        }
    }, []);
    const renderInput = (0,react__WEBPACK_IMPORTED_MODULE_4__.useCallback)((setSubmitted) => ({ field }) => (react__WEBPACK_IMPORTED_MODULE_4___default().createElement((react__WEBPACK_IMPORTED_MODULE_4___default().Fragment), null,
        appliedRedeemableError &&
            appliedRedeemableError.errors &&
            appliedRedeemableError.errors[0] && (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_12__["default"], { type: _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_12__.AlertType.Error }, renderErrorMessage(appliedRedeemableError.errors[0].code, appliedRedeemableError.errors[0].message))),
        react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", { className: "form-prefixPostfix" },
            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_13__["default"], Object.assign({}, field, { "aria-label": language.translate('redeemable.code_label'), className: "form-input optimizedCheckout-form-input", onKeyDown: handleKeyDown(setSubmitted), testId: "redeemableEntry-input" })),
            react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_14__["default"], { className: "form-prefixPostfix-button--postfix body-bold", disabled: isSubmittingOrder(), id: "applyRedeemableButton", isLoading: isApplyingRedeemable, onClick: handleSubmit(setSubmitted), testId: "redeemableEntry-submit", variant: _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_14__.ButtonVariant.Secondary },
                react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_8__["default"], { id: "redeemable.apply_action" }))))), [
        appliedRedeemableError,
        handleKeyDown,
        handleSubmit,
    ...
    const renderContent = (0,react__WEBPACK_IMPORTED_MODULE_4__.useCallback)((0,_bigcommerce_memoize__WEBPACK_IMPORTED_MODULE_1__.memoizeOne)(({ setSubmitted }) => (react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_15__["default"], { input: renderInput(setSubmitted), label: renderLabel, name: "redeemableCode" }))), [renderLabel, renderInput]);
    return (react__WEBPACK_IMPORTED_MODULE_4___default().createElement("fieldset", { className: "form-fieldset redeemable-entry" },
        react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_16__.FormProvider, null, renderContent)));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_9__["default"])((0,formik__WEBPACK_IMPORTED_MODULE_2__.withFormik)({
    mapPropsToValues() {
        return {
            redeemableCode: '',
        };
    ...
    validationSchema({ language }) {
        return (0,yup__WEBPACK_IMPORTED_MODULE_5__.object)({
            redeemableCode: (0,yup__WEBPACK_IMPORTED_MODULE_5__.string)().required(language.translate('redeemable.code_required_error')),
        });
    },
})((0,react__WEBPACK_IMPORTED_MODULE_4__.memo)(Redeemable))));
...
/***/ "./packages/ui/src/icon/IconRemove.tsx"
/*!*********************************************!*\
  !*** ./packages/ui/src/icon/IconRemove.tsx ***!
  \*********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const IconRemoveSvg = () => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", { height: "24", viewBox: "0 0 24 24", width: "24", xmlns: "http://www.w3.org/2000/svg" },
...
const IconRemove = (props) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_IconContainer__WEBPACK_IMPORTED_MODULE_1__["default"], Object.assign({}, props),
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(IconRemoveSvg, null)));
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(IconRemove));
