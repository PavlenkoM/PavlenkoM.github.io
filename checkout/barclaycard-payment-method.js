"use strict";
(self["webpackJsonpCheckout"] = self["webpackJsonpCheckout"] || []).push([["barclaycard-payment-method"],{

/***/ "./packages/barclay-integration/src/BarclaycardPaymentMethod.tsx":
/*!***********************************************************************!*\
  !*** ./packages/barclay-integration/src/BarclaycardPaymentMethod.tsx ***!
  \***********************************************************************/
...
/* harmony import */ var _bigcommerce_checkout_sdk_integrations_offsite__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @bigcommerce/checkout-sdk/integrations/offsite */ "../checkout-sdk-js/dist/esm/integrations/offsite.js");
...
const BarclaycardPaymentMethod = (_a) => {
    ...
    const initializeBarclaycardPayment = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)((options) => {
        return checkoutService.initializePayment(Object.assign(Object.assign({}, options), { integrations: [_bigcommerce_checkout_sdk_integrations_offsite__WEBPACK_IMPORTED_MODULE_1__.createOffsitePaymentStrategy] }));
    }, [checkoutService]);
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_hosted_payment_integration__WEBPACK_IMPORTED_MODULE_3__["default"], Object.assign({}, rest, { checkoutService: checkoutService, checkoutState: checkoutState, deinitializePayment: checkoutService.deinitializePayment, initializePayment: initializeBarclaycardPayment, method: method, paymentForm: paymentForm })));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_bigcommerce_checkout_payment_integration_api__WEBPACK_IMPORTED_MODULE_4__["default"])(BarclaycardPaymentMethod, [{ gateway: 'barclaycard' }]));


/***/ }),

/***/ "./packages/barclay-integration/src/index.ts":
/*!***************************************************!*\
  !*** ./packages/barclay-integration/src/index.ts ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   BarclaycardPaymentMethod: () => (/* reexport safe */ _BarclaycardPaymentMethod__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _BarclaycardPaymentMethod__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BarclaycardPaymentMethod */ "./packages/barclay-integration/src/BarclaycardPaymentMethod.tsx");
...
//# sourceMappingURL=barclaycard-payment-method.js.map