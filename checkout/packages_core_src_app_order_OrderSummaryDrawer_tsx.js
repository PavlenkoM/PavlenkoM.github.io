"use strict";
(self["webpackJsonpCheckout"] = self["webpackJsonpCheckout"] || []).push([["packages_core_src_app_order_OrderSummaryDrawer_tsx"],{
...
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/icon/IconCloseWithBorder.tsx");
...
/* harmony import */ var _currency__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../currency */ "./packages/core/src/app/currency/ShopperCurrency.tsx");
...
/* harmony import */ var _ui_responsive__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../ui/responsive */ "./packages/core/src/app/ui/responsive/isMobileView.ts");
/* harmony import */ var _OrderModalSummarySubheader__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./OrderModalSummarySubheader */ "./packages/core/src/app/order/OrderModalSummarySubheader.tsx");
/* harmony import */ var _OrderSummaryItems__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./OrderSummaryItems */ "./packages/core/src/app/order/OrderSummaryItems.tsx");
/* harmony import */ var _OrderSummaryPrice__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./OrderSummaryPrice */ "./packages/core/src/app/order/OrderSummaryPrice.tsx");
/* harmony import */ var _OrderSummarySection__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./OrderSummarySection */ "./packages/core/src/app/order/OrderSummarySection.tsx");
/* harmony import */ var _OrderSummarySubtotals__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./OrderSummarySubtotals */ "./packages/core/src/app/order/OrderSummarySubtotals.tsx");
/* harmony import */ var _OrderSummaryTotal__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./OrderSummaryTotal */ "./packages/core/src/app/order/OrderSummaryTotal.tsx");
...
const OrderSummaryModal = (_a) => {
    ...
    const subHeaderText = react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_OrderModalSummarySubheader__WEBPACK_IMPORTED_MODULE_15__["default"], { amountWithCurrency: react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_currency__WEBPACK_IMPORTED_MODULE_11__["default"], { amount: total }), items: items, shopperCurrencyCode: shopperCurrency.code, storeCurrencyCode: storeCurrency.code });
    const continueButton = (0,_ui_responsive__WEBPACK_IMPORTED_MODULE_14__["default"])() && react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_7__["default"], { className: 'cart-modal-continue', "data-test": "manage-instrument-cancel-button", onClick: (0,_bigcommerce_checkout_dom_utils__WEBPACK_IMPORTED_MODULE_4__["default"])(onRequestClose) },
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_6__["default"], { id: "cart.return_to_checkout" }));
    return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_ui_modal__WEBPACK_IMPORTED_MODULE_12__["default"], { additionalBodyClassName: "cart-modal-body optimizedCheckout-orderSummary", additionalHeaderClassName: "cart-modal-header optimizedCheckout-orderSummary with-continue-button", additionalModalClassName: "optimizedCheckout-cart-modal", footer: continueButton, header: renderHeader({
            headerLink,
            subHeaderText,
            onRequestClose,
        }), isOpen: isOpen, onAfterOpen: onAfterOpen, onRequestClose: onRequestClose },
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_OrderSummarySection__WEBPACK_IMPORTED_MODULE_18__["default"], null,
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_OrderSummaryItems__WEBPACK_IMPORTED_MODULE_16__["default"], { displayLineItemsCount: false, items: items })),
        isMultiCouponEnabledForCheckout || isMultiCouponEnabledForOrder
            ? react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_coupon__WEBPACK_IMPORTED_MODULE_10__["default"], { fees: orderSummarySubtotalsProps.fees, giftWrappingAmount: orderSummarySubtotalsProps.giftWrappingAmount, handlingAmount: orderSummarySubtotalsProps.handlingAmount, isOrderConfirmation: !!isMultiCouponEnabledForOrder, isTaxIncluded: isTaxIncluded, storeCreditAmount: orderSummarySubtotalsProps.storeCreditAmount, taxes: taxes })
            : react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_OrderSummarySection__WEBPACK_IMPORTED_MODULE_18__["default"], null,
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_OrderSummarySubtotals__WEBPACK_IMPORTED_MODULE_19__["default"], Object.assign({ isTaxIncluded: isTaxIncluded, taxes: taxes }, orderSummarySubtotalsProps)),
                additionalLineItems),
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_OrderSummarySection__WEBPACK_IMPORTED_MODULE_18__["default"], null,
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_OrderSummaryTotal__WEBPACK_IMPORTED_MODULE_20__["default"], { orderAmount: total, shopperCurrencyCode: shopperCurrency.code, storeCurrencyCode: storeCurrency.code }),
            (isTotalDiscountVisible && totalDiscount) &&
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { className: "total-savings" },
        ...
        displayInclusiveTax && react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_OrderSummarySection__WEBPACK_IMPORTED_MODULE_18__["default"], null,
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("h5", { className: "cart-taxItem cart-taxItem--subtotal optimizedCheckout-contentPrimary", "data-test": "tax-text" },
            ...
            (taxes || []).map((tax, index) => (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_OrderSummaryPrice__WEBPACK_IMPORTED_MODULE_17__["default"], { amount: tax.amount, key: index, label: tax.name, testId: "cart-taxes" })))));
};
const renderHeader = ({ onRequestClose, headerLink, subHeaderText }) => {
    let newHeaderLink;
    if ((0,react__WEBPACK_IMPORTED_MODULE_1__.isValidElement)(headerLink)) {
        newHeaderLink = (0,react__WEBPACK_IMPORTED_MODULE_1__.cloneElement)(headerLink, { className: 'modal-header-link cart-modal-link test' });
    }
    return react__WEBPACK_IMPORTED_MODULE_1___default().createElement((react__WEBPACK_IMPORTED_MODULE_1___default().Fragment), null, newHeaderLink !== null && newHeaderLink !== void 0 ? newHeaderLink : headerLink,
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_ui_modal__WEBPACK_IMPORTED_MODULE_13__["default"], { additionalClassName: "cart-modal-title" },
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null,
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_6__["default"], { id: "cart.cart_heading" }),
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { className: 'cart-heading-subheader' }, subHeaderText))),
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("a", { className: "cart-modal-close", href: "#", onClick: (0,_bigcommerce_checkout_dom_utils__WEBPACK_IMPORTED_MODULE_4__["default"])(onRequestClose) },
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", { className: "is-srOnly" },
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_6__["default"], { id: "common.close_action" })),
...
const IconCloseWithBorder = () => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", { fill: "none", height: "37", viewBox: "0 0 38 37", width: "38", xmlns: "http://www.w3.org/2000/svg" },
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_withIconContainer__WEBPACK_IMPORTED_MODULE_1__["default"])(IconCloseWithBorder));


/***/ })

}]);
//# sourceMappingURL=packages_core_src_app_order_OrderSummaryDrawer_tsx.js.map