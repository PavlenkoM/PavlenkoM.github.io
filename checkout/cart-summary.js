...
/* harmony import */ var _bigcommerce_checkout_contexts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @bigcommerce/checkout/contexts */ "./packages/contexts/src/capabilities/CapabilitiesContext.tsx");
...
const CartSummary = (_a) => {
    ...
    const { userJourney: { disableEditCart } } = (0,_bigcommerce_checkout_contexts__WEBPACK_IMPORTED_MODULE_7__.useCapabilities)();
    const headerLink = (0,_bigcommerce_checkout_utility__WEBPACK_IMPORTED_MODULE_8__["default"])(isBuyNowCart, disableEditCart) ? null : (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_EditLink__WEBPACK_IMPORTED_MODULE_4__["default"], { isMultiShippingMode: isMultiShippingMode, url: cartUrl }));
