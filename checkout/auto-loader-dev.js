...
function loadFiles(options) {
  ...
  const isIntegrityHashExperimentEnabled = (_a = options == null ? void 0 : options.isIntegrityHashExperimentEnabled) != null ? _a : true;
  const isCspNonceExperimentEnabled = (_b = options == null ? void 0 : options.isCspNonceExperimentEnabled) != null ? _b : true;
  const {
    appVersion,
    css = [],
    ...
    js = [],
    integrity = {}
  } = {"appVersion":"dev","css":[],"js":["runtime.js","transients.js","vendor-initial.js","checkout.js"],"dynamicChunks":{"css":[],"js":[]},"integrity":{}};
  const scripts = Promise.all(js.filter((path) => !path.startsWith("loader")).map(
  ...
  const stylesheets = Promise.all(css.map(
...
/*!**********************************************!*\
  ...
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./loader */ "./packages/core/src/app/loader.ts");
...
function isCustomCheckoutWindow(window2) {
  const customCheckoutWindow = window2;
...
(function autoLoad() {
  return __async(this, null, function* () {
    ...
    const { renderOrderConfirmation, renderCheckout } = yield (0,_loader__WEBPACK_IMPORTED_MODULE_0__.loadFiles)();
    const _a = window.checkoutConfig, { orderId, checkoutId } = _a, appProps = __objRest(_a, ["orderId", "checkoutId"]);
    if (orderId) {
      renderOrderConfirmation(__spreadProps(__spreadValues({}, appProps), { orderId }));
    } else if (checkoutId) {
      renderCheckout(__spreadProps(__spreadValues({}, appProps), { checkoutId }));
    }
  });
})();
...
/******/ })()
;
//# sourceMappingURL=auto-loader-dev.js.map