...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.mjs");
/* harmony import */ var _bigcommerce_checkout_sdk_integrations_stripe__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @bigcommerce/checkout-sdk/integrations/stripe */ "../checkout-sdk-js/dist/esm/integrations/stripe.js");
...
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/form/LoadingSkeleton/ChecklistSkeleton.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/accordion/AccordionContext.tsx");
/* harmony import */ var _getStripeOCSStyles__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./getStripeOCSStyles */ "./packages/stripe-integration/src/stripe-ocs/getStripeOCSStyles.ts");
...
const StripeOCSPaymentMethod = (_a) => {
    ...
    const { onToggle, selectedItemId } = (0,react__WEBPACK_IMPORTED_MODULE_3__.useContext)(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_9__["default"]);
    ...
    const initializeStripePayment = (0,react__WEBPACK_IMPORTED_MODULE_3__.useCallback)((options) => (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(void 0, void 0, void 0, function* () {
        ...
        return checkoutService.initializePayment(Object.assign(Object.assign({}, options), { integrations: [_bigcommerce_checkout_sdk_integrations_stripe__WEBPACK_IMPORTED_MODULE_1__.createStripeOCSPaymentStrategy, _bigcommerce_checkout_sdk_integrations_stripe__WEBPACK_IMPORTED_MODULE_1__.createStripeCSPaymentStrategy], stripeocs: {
                ...
                appearance: (0,_getStripeOCSStyles__WEBPACK_IMPORTED_MODULE_10__.getAppearanceForOCSElement)(containerId),
                fonts: (0,_getStripeOCSStyles__WEBPACK_IMPORTED_MODULE_10__.getFonts)(),
    ...
    const renderCustomOCSSectionStyles = () => (react__WEBPACK_IMPORTED_MODULE_3___default().createElement("style", null, `
    ...
    const renderPreloader = () => (react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { "data-test": "stripe-accordion-skeleton", style: { padding: '10px 18px' } },
        react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_8__["default"], null)));
    return (react__WEBPACK_IMPORTED_MODULE_3___default().createElement((react__WEBPACK_IMPORTED_MODULE_3___default().Fragment), null,
        ...
        react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_bigcommerce_checkout_hosted_widget_integration__WEBPACK_IMPORTED_MODULE_4__["default"], Object.assign({}, rest, { containerId: containerId, deinitializePayment: checkoutService.deinitializePayment, disableSubmit: disableSubmit, hideContentWhenSignedOut: true, hidePaymentSubmitButton: hidePaymentSubmitButton, initializeCustomer: initializeStripeCustomer, initializePayment: initializeStripePayment, instruments: instruments, isInstrumentCardCodeRequired: (0,_bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_5__["default"])(checkoutState), isInstrumentCardNumberRequired: (0,_bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_6__["default"])(checkoutState), isInstrumentFeatureAvailable: false, isLoadingInstruments: isLoadingInstruments(), isPaymentDataRequired: isPaymentDataRequired(), isSignedIn: (0,lodash__WEBPACK_IMPORTED_MODULE_2__.some)(checkout === null || checkout === void 0 ? void 0 : checkout.payments, { providerId: method.id }), loadInstruments: checkoutService.loadInstruments, method: method, setFieldValue: setFieldValue, setSubmit: setSubmit, setValidationSchema: setValidationSchema, signOut: checkoutService.signOutCustomer })),
        renderCheckoutElementsForStripeOCSStyling()));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_bigcommerce_checkout_payment_integration_api__WEBPACK_IMPORTED_MODULE_7__["default"])(StripeOCSPaymentMethod, [
...
const getAppearanceForOCSElement = (containerId) => {
    ...
    const accordionSelectedHeaderStyles = getStylesFromElement(`#${containerId}--accordion-header-selected`, ['background-color']);
    const formChecklistStyles = getStylesFromElement(`#${containerId}--accordion-header.optimizedCheckout-form-checklist-item`, ['border-bottom', 'border-color']);
