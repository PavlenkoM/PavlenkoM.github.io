...
const PaymentMethodComponent = (props) => {
    const { method } = props;
    if (method.id === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_3__["default"].Humm ||
        method.id === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_3__["default"].Laybuy ||
        method.type === _PaymentMethodProviderType__WEBPACK_IMPORTED_MODULE_4__["default"].Hosted) {
