...
const CartSummaryDrawerV2 = ({ isMultiShippingMode, }) => {
    ...
    const checkoutContext = (0,_bigcommerce_checkout_contexts__WEBPACK_IMPORTED_MODULE_2__.useCheckout)();
    const { userJourney: { disableEditCart }, } = (0,_bigcommerce_checkout_contexts__WEBPACK_IMPORTED_MODULE_1__.useCapabilities)();
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "cart-summary-drawer" },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { "aria-expanded": isExpanded, className: "cart-summary-toggle", onClick: () => setIsExpanded(!isExpanded) },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: "body-regular" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_3__["default"], { id: isExpanded
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_4__.CollapseCSSTransition, { isVisible: isExpanded, nodeRef: nodeRef },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "cart-summary-content", ref: nodeRef }, (0,_withRedeemable__WEBPACK_IMPORTED_MODULE_13__["default"])(_order_OrderSummary__WEBPACK_IMPORTED_MODULE_10__["default"])(Object.assign(Object.assign({}, props), { headerLink: null, showHeader: false }))))));
};
