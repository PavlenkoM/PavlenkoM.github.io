...
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/icon/IconChevronUp.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/icon/IconChevronDown.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/icon/IconArrowLeft.tsx");
/* harmony import */ var _bigcommerce_checkout_utility__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @bigcommerce/checkout/utility */ "./packages/utility/src/hideEditCartLink.ts");
/* harmony import */ var _currency__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../currency */ "./packages/core/src/app/currency/ShopperCurrency.tsx");
/* harmony import */ var _order_OrderSummary__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../order/OrderSummary */ "./packages/core/src/app/order/OrderSummary.tsx");
/* harmony import */ var _EditLink__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./EditLink */ "./packages/core/src/app/cart/EditLink.tsx");
/* harmony import */ var _mapToCartSummaryProps__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./mapToCartSummaryProps */ "./packages/core/src/app/cart/mapToCartSummaryProps.ts");
/* harmony import */ var _withRedeemable__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./withRedeemable */ "./packages/core/src/app/cart/withRedeemable.tsx");
...
const CartSummaryDrawerV2 = ({ isMultiShippingMode }) => {
    ...
    const props = (0,_mapToCartSummaryProps__WEBPACK_IMPORTED_MODULE_12__["default"])(checkoutContext);
    if (!props) {
        return null;
    }
    const { cartUrl, isBuyNowCart, checkout } = props;
    const headerLink = (0,_bigcommerce_checkout_utility__WEBPACK_IMPORTED_MODULE_8__["default"])(isBuyNowCart, disableEditCart) ? null : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_EditLink__WEBPACK_IMPORTED_MODULE_11__["default"], { isMultiShippingMode: isMultiShippingMode, label: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "cart.go_to_cart_action" }), url: cartUrl }));
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "cart-summary-drawer" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'cart-summary-header' },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_7__["default"], null),
            headerLink),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { "aria-expanded": isExpanded, className: "cart-summary-toggle", onClick: () => setIsExpanded(!isExpanded) },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: 'body-regular' },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_3__["default"], { id: isExpanded ? 'cart.hide_order_summary_action' : 'cart.show_order_summary_action' }),
                isExpanded ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_5__["default"], null) : react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_6__["default"], null)),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: "sub-header" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_currency__WEBPACK_IMPORTED_MODULE_9__["default"], { amount: checkout.outstandingBalance }))),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_4__.CollapseCSSTransition, { isVisible: isExpanded, nodeRef: nodeRef },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { ref: nodeRef }, ((0,_withRedeemable__WEBPACK_IMPORTED_MODULE_13__["default"])(_order_OrderSummary__WEBPACK_IMPORTED_MODULE_10__["default"])(Object.assign(Object.assign({}, props), { headerLink: null, showHeader: false })))))));
};
...
const OrderSummary = (_a) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement("article", { className: "cart optimizedCheckout-orderSummary", "data-test": "cart" },
        ...
        isMultiCouponEnabledForCheckout || isMultiCouponEnabledForOrder
            ? react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_coupon__WEBPACK_IMPORTED_MODULE_8__["default"], { fees: orderSummarySubtotalsProps.fees, giftWrappingAmount: orderSummarySubtotalsProps.giftWrappingAmount, handlingAmount: orderSummarySubtotalsProps.handlingAmount, isOrderConfirmation: isMultiCouponEnabledForOrder, isTaxIncluded: isTaxIncluded, storeCreditAmount: orderSummarySubtotalsProps.storeCreditAmount, taxes: taxes })
            : react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_OrderSummarySection__WEBPACK_IMPORTED_MODULE_12__["default"], null,
...
const IconArrowLeftSvg = () => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", { height: "24", viewBox: "0 0 24 24", width: "24", xmlns: "http://www.w3.org/2000/svg" },
...
const IconArrowLeft = (props) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_IconContainer__WEBPACK_IMPORTED_MODULE_1__["default"], Object.assign({}, props),
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(IconArrowLeftSvg, null)));
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(IconArrowLeft));
