...
/* harmony import */ var _bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @bigcommerce/checkout/instrument-utils */ "./packages/instrument-utils/src/guards/isPaymentMethodAutoVaultingInstruments/isPaymentMethodAutoVaultingInstruments.ts");
/* harmony import */ var _bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @bigcommerce/checkout/instrument-utils */ "./packages/instrument-utils/src/storedInstrument/getInstrumentValidationSchema/getInstrumentValidationSchema.ts");
/* harmony import */ var _bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @bigcommerce/checkout/instrument-utils */ "./packages/instrument-utils/src/creditCard/getCreditCardValidationSchema/getCreditCardValidationSchema.ts");
/* harmony import */ var _bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @bigcommerce/checkout/instrument-utils */ "./packages/instrument-utils/src/creditCard/configureCardValidator.ts");
/* harmony import */ var _bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @bigcommerce/checkout/instrument-utils */ "./packages/instrument-utils/src/storedInstrument/CardInstrumentFieldset/CardInstrumentFieldset.tsx");
/* harmony import */ var _bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @bigcommerce/checkout/instrument-utils */ "./packages/instrument-utils/src/creditCard/CreditCardValidation/CreditCardValidation.tsx");
/* harmony import */ var _bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @bigcommerce/checkout/instrument-utils */ "./packages/instrument-utils/src/creditCard/CreditCardFieldset/CreditCardFieldset.tsx");
/* harmony import */ var _bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @bigcommerce/checkout/instrument-utils */ "./packages/instrument-utils/src/storedInstrument/StoreInstrumentFieldset/StoreInstrumentFieldset.tsx");
/* harmony import */ var _bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @bigcommerce/checkout/instrument-utils */ "./packages/instrument-utils/src/storedInstrument/AutoVaultingDisclaimer/AutoVaultingDisclaimer.tsx");
/* harmony import */ var _bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @bigcommerce/checkout/instrument-utils */ "./packages/instrument-utils/src/guards/isInstrumentCardCodeRequiredSelector.ts");
/* harmony import */ var _bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @bigcommerce/checkout/instrument-utils */ "./packages/instrument-utils/src/guards/isInstrumentCardNumberRequiredSelector.ts");
/* harmony import */ var _bigcommerce_checkout_payment_integration_api__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @bigcommerce/checkout/payment-integration-api */ "./packages/payment-integration-api/src/CaptureMessageComponent.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/loading/LoadingOverlay.tsx");
...
const CreditCardPaymentMethodComponent = (props) => {
    ...
    const getCreditCardPaymentMethodDerivedProps = () => {
        ...
        return {
            ...
            isInstrumentCardCodeRequired: (0,_bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_15__["default"])(checkoutState),
            isInstrumentCardNumberRequired: (0,_bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_16__["default"])(checkoutState),
            isInstrumentFeatureAvailable: isInstrumentFeatureAvailableFlag,
            isLoadingInstruments: isLoadingInstrumentsProp(),
            isPaymentDataRequired: isPaymentDataRequired(),
            shouldShowAutoVaultingDisclaimer: (0,_bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_6__["default"])(method),
    ...
    const handleDeleteInstrument = (id) => {
        ...
        const remainingInstruments = instruments.filter((instrument) => instrument.bigpayToken !== id);
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
        const init = () => (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(void 0, void 0, void 0, function* () {
            ...
            (0,_bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_9__["default"])();
            try {
    ...
    const { instruments: outerInstruments, isInstrumentCardCodeRequired: isInstrumentCardCodeRequiredProp, isInstrumentCardNumberRequired: isInstrumentCardNumberRequiredProp, isInstrumentFeatureAvailable: isInstrumentFeatureAvailableProp, isLoadingInstruments, shouldShowAutoVaultingDisclaimer, shouldShowInstrumentFieldset, } = getCreditCardPaymentMethodDerivedProps();
    ...
    return (react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_18__["default"], { hideContentWhenLoading: true, isLoading: isLoading },
        react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { className: "paymentMethod paymentMethod--creditCard", "data-test": "credit-cart-payment-method" },
            shouldShowInstrumentFieldset && (react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_10__["default"], { instruments: outerInstruments, onDeleteInstrument: handleDeleteInstrument, onSelectInstrument: handleSelectInstrument, onUseNewInstrument: handleUseNewCard, selectedInstrumentId: selectedInstrument && selectedInstrument.bigpayToken, validateInstrument: getStoredCardValidationFieldset ? (getStoredCardValidationFieldset(selectedInstrument)) : (react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_11__["default"], { shouldShowCardCodeField: shouldShowCardCodeField, shouldShowNumberField: shouldShowNumberField })) })),
            shouldShowCreditCardFieldset && !cardFieldset && (react__WEBPACK_IMPORTED_MODULE_3___default().createElement((react__WEBPACK_IMPORTED_MODULE_3___default().Fragment), null,
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_bigcommerce_checkout_payment_integration_api__WEBPACK_IMPORTED_MODULE_17__.CaptureMessageComponent, { message: SentryMessage }),
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_12__["default"], { shouldShowCardCodeField: methodProp.config.cardCode || methodProp.config.cardCode === null, shouldShowCustomerCodeField: methodProp.config.requireCustomerCode }))),
            shouldShowCreditCardFieldset && cardFieldset,
            isInstrumentFeatureAvailableProp && (react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_13__["default"], { instrumentId: selectedInstrument && selectedInstrument.bigpayToken, instruments: outerInstruments })),
            shouldShowAutoVaultingDisclaimer && shouldShowCreditCardFieldset && (react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_bigcommerce_checkout_instrument_utils__WEBPACK_IMPORTED_MODULE_14__["default"], null)))));
};
...
const CreditCardPaymentMethodComponentContainer = (props) => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
        const init = () => (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(void 0, void 0, void 0, function* () {
            const { checkoutService, checkoutState, isUsingMultiShipping = false, method, onUnhandledError, } = props;
...
const CreditCardFieldset = ({ shouldShowCardCodeField, shouldShowCustomerCodeField, }) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_2__["default"], { additionalClassName: "creditCardFieldset form-fieldset--creditCardFieldset", legend: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_3__["default"], { hidden: true },
...
/***/ "./packages/instrument-utils/src/guards/isPaymentMethodAutoVaultingInstruments/isPaymentMethodAutoVaultingInstruments.ts"
/*!*******************************************************************************************************************************!*\
  !*** ./packages/instrument-utils/src/guards/isPaymentMethodAutoVaultingInstruments/isPaymentMethodAutoVaultingInstruments.ts ***!
  \*******************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ isPaymentMethodAutoVaultingInstruments)
/* harmony export */ });
function isPaymentMethodAutoVaultingInstruments(paymentMethod) {
...
/***/ "./packages/instrument-utils/src/storedInstrument/AutoVaultingDisclaimer/AutoVaultingDisclaimer.tsx"
/*!**********************************************************************************************************!*\
  !*** ./packages/instrument-utils/src/storedInstrument/AutoVaultingDisclaimer/AutoVaultingDisclaimer.tsx ***!
  \**********************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const AutoVaultingDisclaimer = () => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: "auto-vaulting-disclaimer optimizedCheckout-secondaryDarkest sub-text-medium", "data-test": "auto-vaulting-disclaimer" },
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_1__["default"], { id: "payment.auto_vaulting_disclaimer" })));
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(AutoVaultingDisclaimer));
