...
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/modal/ModalTrigger.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/icon/IconGiftCertificate.tsx");
...
const OrderSummaryDrawer = ({ handlingAmount, headerLink, isTaxIncluded, lineItems, shopperCurrency, storeCreditAmount, giftWrappingAmount, storeCurrency, taxes, total, fees, }) => {
    const nonBundledLineItems = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => (0,_removeBundledItems__WEBPACK_IMPORTED_MODULE_9__.removeBundledItems)(lineItems), [lineItems]);
    const renderModal = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)((props) => (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_OrderSummaryModal__WEBPACK_IMPORTED_MODULE_8__["default"], Object.assign({}, props, { fees: fees, giftWrappingAmount: giftWrappingAmount, handlingAmount: handlingAmount, headerLink: headerLink, isTaxIncluded: isTaxIncluded, items: lineItems, shopperCurrency: shopperCurrency, storeCreditAmount: storeCreditAmount, storeCurrency: storeCurrency, taxes: taxes, total: total }))), [
        handlingAmount,
        headerLink,
        isTaxIncluded,
        lineItems,
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_3__["default"], { modal: renderModal }, ({ onClick, onKeyPress }) => (react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { className: "cartDrawer optimizedCheckout-orderSummary", onClick: onClick, onKeyPress: onKeyPress, tabIndex: 0 },
        ...
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", { className: "cartDrawer-actions" },
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("h3", { className: "cartDrawer-total optimizedCheckout-headingPrimary" },
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_currency__WEBPACK_IMPORTED_MODULE_5__["default"], { amount: total })))))));
};
function getImage(lineItems) {
    ...
    if (lineItems.giftCertificates.length) {
        return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_4__["default"], null);
    }
}
...
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/responsive/isMobileView.ts");
...
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/icon/IconCloseWithBorder.tsx");
/* harmony import */ var _coupon__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../coupon */ "./packages/core/src/app/coupon/OrderSummarySubtotals.tsx");
/* harmony import */ var _currency__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../currency */ "./packages/core/src/app/currency/ShopperCurrency.tsx");
/* harmony import */ var _OrderModalSummarySubheader__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./OrderModalSummarySubheader */ "./packages/core/src/app/order/OrderModalSummarySubheader.tsx");
/* harmony import */ var _OrderSummaryItems__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./OrderSummaryItems */ "./packages/core/src/app/order/OrderSummaryItems.tsx");
/* harmony import */ var _OrderSummaryPrice__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./OrderSummaryPrice */ "./packages/core/src/app/order/OrderSummaryPrice.tsx");
/* harmony import */ var _OrderSummarySection__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./OrderSummarySection */ "./packages/core/src/app/order/OrderSummarySection.tsx");
...
/* harmony import */ var _removeBundledItems__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./removeBundledItems */ "./packages/core/src/app/order/removeBundledItems.ts");
...
const OrderSummaryModal = (_a) => {
    var { isTaxIncluded, taxes, onRequestClose, onAfterOpen, storeCurrency, shopperCurrency, isOpen, headerLink, items, total } = _a, orderSummarySubtotalsProps = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__rest)(_a, ["isTaxIncluded", "taxes", "onRequestClose", "onAfterOpen", "storeCurrency", "shopperCurrency", "isOpen", "headerLink", "items", "total"]);
    ...
    const nonBundledItems = (0,_removeBundledItems__WEBPACK_IMPORTED_MODULE_21__.removeBundledItems)(items);
    const subHeaderText = (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_OrderModalSummarySubheader__WEBPACK_IMPORTED_MODULE_16__["default"], { amountWithCurrency: react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_currency__WEBPACK_IMPORTED_MODULE_15__["default"], { amount: total }), items: nonBundledItems, shopperCurrencyCode: shopperCurrency.code, storeCurrencyCode: storeCurrency.code }));
    const continueButton = (0,_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_11__.isMobileView)() && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_9__["default"], { className: "cart-modal-continue", "data-test": "manage-instrument-cancel-button", onClick: (0,_bigcommerce_checkout_dom_utils__WEBPACK_IMPORTED_MODULE_6__["default"])(onRequestClose) },
    ...
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_10__["default"], { additionalBodyClassName: "cart-modal-body optimizedCheckout-orderSummary", additionalHeaderClassName: "cart-modal-header optimizedCheckout-orderSummary with-continue-button", additionalModalClassName: classnames__WEBPACK_IMPORTED_MODULE_1___default()('optimizedCheckout-cart-modal', {
            enhancedThemeV1,
        }), footer: continueButton, header: renderHeader({
            headerLink,
            subHeaderText,
            onRequestClose,
        }), isOpen: isOpen, onAfterOpen: onAfterOpen, onRequestClose: onRequestClose },
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_OrderSummarySection__WEBPACK_IMPORTED_MODULE_19__["default"], null,
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_OrderSummaryItems__WEBPACK_IMPORTED_MODULE_17__["default"], { displayLineItemsCount: false, items: items })),
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_coupon__WEBPACK_IMPORTED_MODULE_14__["default"], { fees: orderSummarySubtotalsProps.fees, giftWrappingAmount: orderSummarySubtotalsProps.giftWrappingAmount, handlingAmount: orderSummarySubtotalsProps.handlingAmount, isOrderConfirmation: isOrderConfirmation, isTaxIncluded: isTaxIncluded, storeCreditAmount: orderSummarySubtotalsProps.storeCreditAmount, taxes: taxes }),
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_OrderSummarySection__WEBPACK_IMPORTED_MODULE_19__["default"], null,
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_OrderSummaryTotal__WEBPACK_IMPORTED_MODULE_20__["default"], { orderAmount: total, shopperCurrencyCode: shopperCurrency.code, storeCurrencyCode: storeCurrency.code }),
            isTotalDiscountVisible && totalDiscount && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "total-savings optimizedCheckout-contentSecondary" },
        ...
        displayInclusiveTax && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_OrderSummarySection__WEBPACK_IMPORTED_MODULE_19__["default"], null,
            ...
            (taxes || []).map((tax, index) => (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_OrderSummaryPrice__WEBPACK_IMPORTED_MODULE_18__["default"], { amount: tax.amount, key: index, label: tax.name, testId: "cart-taxes" })))))));
};
const renderHeader = ({ onRequestClose, headerLink, subHeaderText }) => {
    ...
    if ((0,react__WEBPACK_IMPORTED_MODULE_2__.isValidElement)(headerLink)) {
        newHeaderLink = (0,react__WEBPACK_IMPORTED_MODULE_2__.cloneElement)(headerLink, {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement((react__WEBPACK_IMPORTED_MODULE_2___default().Fragment), null, newHeaderLink !== null && newHeaderLink !== void 0 ? newHeaderLink : headerLink,
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_12__["default"], { additionalClassName: "cart-modal-title" },
        ...
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("a", { className: "cart-modal-close", href: "#", onClick: (0,_bigcommerce_checkout_dom_utils__WEBPACK_IMPORTED_MODULE_6__["default"])(onRequestClose) },
            ...
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_13__["default"], null))));
};
