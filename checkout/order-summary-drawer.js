...
/* harmony import */ var _coupon__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../coupon */ "./packages/core/src/app/coupon/NewOrderSummarySubtotals.tsx");
/* harmony import */ var _currency__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../currency */ "./packages/core/src/app/currency/ShopperCurrency.tsx");
...
const OrderSummaryModal = (_a) => {
    ...
    const isMultiCouponEnabled = (0,_common_utility__WEBPACK_IMPORTED_MODULE_14__["default"])(checkoutSettings, 'CHECKOUT-9674.multi_coupon_cart_checkout', false);
    ...
    const subHeaderText = (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_OrderModalSummarySubheader__WEBPACK_IMPORTED_MODULE_17__["default"], { amountWithCurrency: react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_currency__WEBPACK_IMPORTED_MODULE_16__["default"], { amount: total }), items: items, shopperCurrencyCode: shopperCurrency.code, storeCurrencyCode: storeCurrency.code }));
    ...
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_10__["default"], { additionalBodyClassName: "cart-modal-body optimizedCheckout-orderSummary", additionalHeaderClassName: "cart-modal-header optimizedCheckout-orderSummary with-continue-button", additionalModalClassName: classnames__WEBPACK_IMPORTED_MODULE_1___default()('optimizedCheckout-cart-modal', {
        ...
        isMultiCouponEnabledForCheckout || isMultiCouponEnabledForOrder ? (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_coupon__WEBPACK_IMPORTED_MODULE_15__["default"], { fees: orderSummarySubtotalsProps.fees, giftWrappingAmount: orderSummarySubtotalsProps.giftWrappingAmount, handlingAmount: orderSummarySubtotalsProps.handlingAmount, isOrderConfirmation: !!isMultiCouponEnabledForOrder, isTaxIncluded: isTaxIncluded, storeCreditAmount: orderSummarySubtotalsProps.storeCreditAmount, taxes: taxes })) : (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_OrderSummarySection__WEBPACK_IMPORTED_MODULE_20__["default"], null,
        ...
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_OrderSummarySection__WEBPACK_IMPORTED_MODULE_20__["default"], null,
            ...
            isTotalDiscountVisible && totalDiscount && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "total-savings" },
