    ...
    const handleSignIn = (0,react__WEBPACK_IMPORTED_MODULE_7__.useCallback)((credentials) => (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(void 0, void 0, void 0, function* () {
        try {
            ...
            yield customerData.actions.signIn(credentials, {
                methodId: methodId !== _payment_paymentMethod__WEBPACK_IMPORTED_MODULE_10__["default"].StripeUPE ? methodId : undefined,
            });
            onSignIn();
...
const GuestForm = ({ canSubscribe, checkoutButtons, continueAsGuestButtonLabelId, defaultShouldSubscribe, isLoading, onChangeEmail, onShowLogin, privacyPolicyUrl, requiresMarketingConsent, isExpressPrivacyPolicy, isFloatingLabelEnabled, shouldShowEmailWatermark, setFieldValue, }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_9__["default"], { className: "checkout-form", id: "checkout-customer-guest", testId: "checkout-customer-guest" },
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_10__["default"], { legend: react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_11__["default"], { hidden: true },
            ...
            themeV2 && !isLoading && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("p", { className: "customer-login-link body-regular" },
            ...
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "customerEmail-container" },
                ...
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: classnames__WEBPACK_IMPORTED_MODULE_0___default()('form-actions customerEmail-action', {
                    ...
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_13__["default"], { className: "customerEmail-button body-bold", id: "checkout-customer-continue", isLoading: isLoading, testId: "customer-continue-as-guest-button", type: "submit", variant: _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_13__.ButtonVariant.Primary },
            ...
            privacyPolicyUrl && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_privacyPolicy__WEBPACK_IMPORTED_MODULE_14__["default"], { isExpressPrivacyPolicy: isExpressPrivacyPolicy, url: privacyPolicyUrl })),
            !themeV2 && !isLoading && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("p", { className: "customer-login-link" },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_6__["default"], { id: "customer.login_text" }),
                ' ',
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("a", { "data-test": "customer-continue-button", id: "checkout-customer-login", onClick: handleLogin, role: "button", tabIndex: 0 },
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_6__["default"], { id: "customer.login_action" })))),
...
const GuestFormContainer = ({ email, isFloatingLabelEnabled, isWalletButtonsOnTop, isSubscribed, step, checkEmbeddedSupport, handleChangeEmail, handleContinueAsGuest, handleShowLogin, onWalletButtonClick, onUnhandledError, }) => {
    ...
    const checkoutButtons = isWalletButtonsOnTop || !isPaymentDataRequired() ? null : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_CheckoutButtonList__WEBPACK_IMPORTED_MODULE_6__["default"], { checkEmbeddedSupport: checkEmbeddedSupport, deinitialize: deinitializeCustomer, initialize: initializeCustomer, isInitializing: isInitializingCustomer(), methodIds: checkoutButtonIds, onClick: onWalletButtonClick, onError: onUnhandledError }));
...
/* harmony import */ var _bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @bigcommerce/checkout/locale */ "./packages/locale/src/TranslatedLink.tsx");
...
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/form/Legend/Legend.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/alert/Alert.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/button/Button.tsx");
/* harmony import */ var _CustomerViewType__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./CustomerViewType */ "./packages/core/src/app/customer/CustomerViewType.ts");
/* harmony import */ var _EmailField__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./EmailField */ "./packages/core/src/app/customer/EmailField.tsx");
/* harmony import */ var _getEmailValidationSchema__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./getEmailValidationSchema */ "./packages/core/src/app/customer/getEmailValidationSchema.ts");
/* harmony import */ var _mapErrorMessage__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./mapErrorMessage */ "./packages/core/src/app/customer/mapErrorMessage.ts");
/* harmony import */ var _PasswordField__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./PasswordField */ "./packages/core/src/app/customer/PasswordField.tsx");
/* harmony import */ var _RedirectToStorefrontLogin__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./RedirectToStorefrontLogin */ "./packages/core/src/app/customer/RedirectToStorefrontLogin.tsx");
...
const LoginForm = ({ continueAsGuestButtonLabelId, email, isEmbedded, language, signInError, onCancel = lodash__WEBPACK_IMPORTED_MODULE_1__.noop, onChangeEmail, onContinueAsGuest, onCreateAccount = lodash__WEBPACK_IMPORTED_MODULE_1__.noop, onSendLoginEmail = lodash__WEBPACK_IMPORTED_MODULE_1__.noop, isFloatingLabelEnabled, viewType = _CustomerViewType__WEBPACK_IMPORTED_MODULE_15__["default"].Login, }) => {
    ...
    const changeEmailLink = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)(() => {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("p", { className: "optimizedCheckout-contentSecondary" },
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_7__["default"], { data: { email }, id: "customer.guest_could_login_change_email", onClick: onCancel, testId: "change-email" })));
    }, [email, onCancel]);
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_10__["default"], { className: "checkout-form", id: "checkout-customer-returning", testId: "checkout-customer-returning" },
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_11__["default"], { legend: react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_12__["default"], { hidden: true },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_8__["default"], { id: "customer.returning_customer_text" })) },
            signInError && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_13__["default"], { testId: "customer-login-error-message", type: _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_13__.AlertType.Error }, (0,_mapErrorMessage__WEBPACK_IMPORTED_MODULE_18__["default"])(signInError, (key) => language.translate(key)))),
            viewType === _CustomerViewType__WEBPACK_IMPORTED_MODULE_15__["default"].SuggestedLogin && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_13__["default"], { type: _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_13__.AlertType.Info },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_6__["default"], { data: { email }, id: "customer.guest_could_login" }))),
            viewType === _CustomerViewType__WEBPACK_IMPORTED_MODULE_15__["default"].CancellableEnforcedLogin && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_13__["default"], { type: _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_13__.AlertType.Info },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_6__["default"], { data: { email }, id: "customer.guest_must_login" }))),
            viewType === _CustomerViewType__WEBPACK_IMPORTED_MODULE_15__["default"].EnforcedLogin && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_13__["default"], { type: _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_13__.AlertType.Error },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_7__["default"], { id: "customer.guest_temporary_disabled", onClick: onCreateAccount }))),
            (viewType === _CustomerViewType__WEBPACK_IMPORTED_MODULE_15__["default"].Login ||
                viewType === _CustomerViewType__WEBPACK_IMPORTED_MODULE_15__["default"].EnforcedLogin) && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_EmailField__WEBPACK_IMPORTED_MODULE_16__["default"], { isFloatingLabelEnabled: isFloatingLabelEnabled, onChange: onChangeEmail })),
            !shouldRedirectToStorefrontForAuth && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_PasswordField__WEBPACK_IMPORTED_MODULE_19__["default"], { isFloatingLabelEnabled: isFloatingLabelEnabled })),
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("p", { className: "form-legend-container body-cta" },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("span", null,
                    isSignInEmailEnabled && !isEmbedded && !isBuyNowCart && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_7__["default"], { id: "login_email.link", onClick: onSendLoginEmail, testId: "customer-signin-link" })),
                    !isSignInEmailEnabled &&
                        ...
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_8__["default"], { id: "customer.forgot_password_action" })))),
                viewType === _CustomerViewType__WEBPACK_IMPORTED_MODULE_15__["default"].Login && shouldShowCreateAccountLink && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("span", null,
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_7__["default"], { id: "customer.create_account_to_continue_text", onClick: onCreateAccount })))),
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "form-actions" },
                shouldRedirectToStorefrontForAuth ? (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_RedirectToStorefrontLogin__WEBPACK_IMPORTED_MODULE_20__.RedirectToStorefrontLogin, { isDisabled: Boolean(isSigningIn() || isExecutingPaymentMethodCheckout()), isLoading: Boolean(isSigningIn() || isExecutingPaymentMethodCheckout()) })) : (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_14__["default"], { className: "body-bold", disabled: isSigningIn() || isExecutingPaymentMethodCheckout(), id: "checkout-customer-continue", isLoading: isSigningIn() || isExecutingPaymentMethodCheckout(), testId: "customer-continue-button", type: "submit", variant: _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_14__.ButtonVariant.Primary },
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_8__["default"], { id: "customer.sign_in_action" }))),
                viewType === _CustomerViewType__WEBPACK_IMPORTED_MODULE_15__["default"].SuggestedLogin && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("a", { className: "button optimizedCheckout-buttonSecondary body-bold", "data-test": "customer-guest-continue", href: "#", id: "checkout-guest-continue", onClick: (0,_bigcommerce_checkout_dom_utils__WEBPACK_IMPORTED_MODULE_5__["default"])(onContinueAsGuest) },
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_8__["default"], { id: continueAsGuestButtonLabelId }))),
                canCancel &&
                    viewType !== _CustomerViewType__WEBPACK_IMPORTED_MODULE_15__["default"].EnforcedLogin &&
                    viewType !== _CustomerViewType__WEBPACK_IMPORTED_MODULE_15__["default"].SuggestedLogin && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("a", { className: "button optimizedCheckout-buttonSecondary body-bold", "data-test": "customer-cancel-button", href: "#", id: "checkout-customer-cancel", onClick: (0,_bigcommerce_checkout_dom_utils__WEBPACK_IMPORTED_MODULE_5__["default"])(onCancel) },
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_8__["default"], { id: viewType === _CustomerViewType__WEBPACK_IMPORTED_MODULE_15__["default"].CancellableEnforcedLogin
                            ? 'login_email.use_another_email'
                            : 'common.cancel_action' })))),
            viewType === _CustomerViewType__WEBPACK_IMPORTED_MODULE_15__["default"].SuggestedLogin && changeEmailLink())));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_9__["default"])((0,formik__WEBPACK_IMPORTED_MODULE_0__.withFormik)({
    mapPropsToValues: ({ email = '' }) => ({
        email,
        password: '',
    }),
    ...
    validationSchema: ({ language }) => (0,_getEmailValidationSchema__WEBPACK_IMPORTED_MODULE_17__["default"])({ language }).concat((0,yup__WEBPACK_IMPORTED_MODULE_3__.object)({
...
/* harmony import */ var yup__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! yup */ "./node_modules/yup/es/index.js");
/* harmony import */ var _bigcommerce_checkout_contexts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @bigcommerce/checkout/contexts */ "./packages/contexts/src/theme/ThemeContext.tsx");
/* harmony import */ var _bigcommerce_checkout_dom_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @bigcommerce/checkout/dom-utils */ "./packages/dom-utils/src/getAppliedStyles.ts");
/* harmony import */ var _bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @bigcommerce/checkout/locale */ "./packages/locale/src/TranslatedString.tsx");
/* harmony import */ var _bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @bigcommerce/checkout/locale */ "./packages/locale/src/withLanguage.tsx");
...
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/form/Fieldset/Fieldset.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/form/Legend/Legend.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/form/BasicFormField/BasicFormField.tsx");
...
/* harmony import */ var _privacyPolicy__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../privacyPolicy */ "./packages/core/src/app/privacyPolicy/PrivacyPolicyField.tsx");
/* harmony import */ var _privacyPolicy__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../privacyPolicy */ "./packages/core/src/app/privacyPolicy/getPrivacyPolicyValidationSchema.ts");
/* harmony import */ var _SubscribeField__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./SubscribeField */ "./packages/core/src/app/customer/SubscribeField.tsx");
...
const StripeGuestForm = ({ continueAsGuestButtonLabelId, isLoading, initialize, isExpressPrivacyPolicy, deinitialize, onChangeEmail, onShowLogin, onContinueAsGuest, canSubscribe, checkoutButtons, defaultShouldSubscribe, requiresMarketingConsent, privacyPolicyUrl, step, status, setFieldValue, }) => {
    ...
    const getStylesFromElement = (id, properties) => {
        ...
        if (parentContainer) {
            return (0,_bigcommerce_checkout_dom_utils__WEBPACK_IMPORTED_MODULE_5__["default"])(parentContainer, properties);
        }
        return undefined;
    };
    ...
    const renderField = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)((fieldProps) => (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_SubscribeField__WEBPACK_IMPORTED_MODULE_15__["default"], Object.assign({}, fieldProps, { requiresMarketingConsent: requiresMarketingConsent }))), [requiresMarketingConsent]);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement((react__WEBPACK_IMPORTED_MODULE_2___default().Fragment), null,
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_8__["default"], { className: "checkout-form", id: "checkout-customer-guest", testId: "checkout-customer-guest" },
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "checkout-form", style: { display: isStripeLoading ? 'none' : undefined } },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_9__["default"], { legend: !authentication && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_10__["default"], { hidden: true },
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_6__["default"], { id: "customer.guest_customer_text" }))) },
                    themeV2 && !isLoading && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("p", { className: "customer-login-link body-regular" },
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_6__["default"], { id: "customer.login_text" }),
                        ' ',
                    ...
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "customerEmail-container" },
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "customerEmail-body" },
                            ...
                            (canSubscribe || requiresMarketingConsent) && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_11__["default"], { name: "shouldSubscribe", render: renderField }))),
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "form-actions customerEmail-action" }, (!authentication || (authentication && !isNewAuth)) && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_12__["default"], { className: "stripeCustomerEmail-button", disabled: continueAsAGuestButton, id: "stripe-checkout-customer-continue", isLoading: isLoading, testId: "stripe-customer-continue-as-guest-button", type: "submit", variant: _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_12__.ButtonVariant.Primary },
                            react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_6__["default"], { id: buttonText }))))),
                    privacyPolicyUrl && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_privacyPolicy__WEBPACK_IMPORTED_MODULE_13__["default"], { isExpressPrivacyPolicy: isExpressPrivacyPolicy, url: privacyPolicyUrl })),
                    !themeV2 && !isLoading && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("p", null,
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_6__["default"], { id: "customer.login_text" }),
                        ' ',
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("a", { "data-test": "customer-continue-button", id: "checkout-customer-login", onClick: onShowLogin, role: "button", tabIndex: 0 },
                            react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_6__["default"], { id: "customer.login_action" })))),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_7__["default"])((0,formik__WEBPACK_IMPORTED_MODULE_1__.withFormik)({
    ...
    validationSchema: ({ language, privacyPolicyUrl, isExpressPrivacyPolicy, }) => {
        if (privacyPolicyUrl && !isExpressPrivacyPolicy) {
            return (0,_privacyPolicy__WEBPACK_IMPORTED_MODULE_14__["default"])({
                isRequired: !!privacyPolicyUrl,
                language,
            });
        }
...
const PrivacyPolicyAutoConsent = ({ url }) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: "body-regular" },
