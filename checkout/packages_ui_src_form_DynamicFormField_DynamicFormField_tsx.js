...
const MultiCheckboxFormField = ({ form: { values, errors }, id, label, name, onChange = lodash__WEBPACK_IMPORTED_MODULE_1__.noop, options, push, remove, themeV2, }) => {
    ...
    react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_FormFieldContainer__WEBPACK_IMPORTED_MODULE_3__["default"], { hasError: (0,formik__WEBPACK_IMPORTED_MODULE_0__.getIn)(errors, name) && (0,formik__WEBPACK_IMPORTED_MODULE_0__.getIn)(errors, name).length },
        label,
        options.length > 1 && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_MultiCheckboxControl__WEBPACK_IMPORTED_MODULE_7__["default"], { onSelectedAll: handleSelectAll, onSelectedNone: handleSelectNone, testId: id, themeV2: themeV2 })),
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_DynamicInput__WEBPACK_IMPORTED_MODULE_6__["default"], { fieldType: _DynamicFormFieldType__WEBPACK_IMPORTED_MODULE_5__["default"].CHECKBOX, id: id, name: name, onChange: handleInputChange, options: options, themeV2: themeV2, 
            // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
...
const CheckboxGroupFormField = ({ id, label, name, onChange, options, themeV2, }) => {
    const renderField = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)((renderProps) => (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(MultiCheckboxFormField, Object.assign({ id: id, label: label, name: name, onChange: onChange, options: options, themeV2: themeV2 }, (0,lodash__WEBPACK_IMPORTED_MODULE_1__.pick)(renderProps, ['form', 'pop', 'push', 'remove'])))), [id, label, name, onChange, options, themeV2]);
...
const DynamicFormField = ({ field: { fieldType, type, secret, name, label: fieldLabel, required, options, max, min, maxLength, }, parentFieldName, onChange, placeholder, inputId, autocomplete, label, extraClass, isFloatingLabelEnabled, themeV2 = false, }) => {
...
const DynamicInput = (_a) => {
    var { fieldType, id, name, onChange = lodash__WEBPACK_IMPORTED_MODULE_2__.noop, options, placeholder, value, isFloatingLabelEnabled, themeV2 = false, date, inputDateFormat } = _a, rest = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__rest)(_a, ["fieldType", "id", "name", "onChange", "options", "placeholder", "value", "isFloatingLabelEnabled", "themeV2", "date", "inputDateFormat"]);
    ...
    switch (fieldType) {
        case _DynamicFormFieldType__WEBPACK_IMPORTED_MODULE_10__["default"].DROPDOWM:
            return (react__WEBPACK_IMPORTED_MODULE_3___default().createElement((react__WEBPACK_IMPORTED_MODULE_3___default().Fragment), null,
                ...
                react__WEBPACK_IMPORTED_MODULE_3___default().createElement("select", Object.assign({}, rest, { className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({ 'floating-select': isFloatingLabelEnabled }, 'form-select optimizedCheckout-form-select', { 'floating-form-field-input': themeV2 }), "data-test": `${id}-select`, id: id, name: name, onChange: onChange, value: value !== null && value !== void 0 ? value : '' }),
...
/* harmony import */ var _MultiCheckboxControl_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./MultiCheckboxControl.scss */ "./packages/ui/src/form/DynamicFormField/MultiCheckboxControl.scss");
/* harmony import */ var _MultiCheckboxControl_scss__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_MultiCheckboxControl_scss__WEBPACK_IMPORTED_MODULE_3__);
/* istanbul ignore file */




const MultiCheckboxControl = ({ testId, onSelectedAll, onSelectedNone, themeV2 = false, }) => {
    const handleSelectAllClick = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)((event) => {
        event.preventDefault();
        onSelectedAll();
    }, [onSelectedAll]);
    const handleSelectNoneClick = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)((event) => {
        event.preventDefault();
        onSelectedNone();
    }, [onSelectedNone]);
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement("ul", { className: classnames__WEBPACK_IMPORTED_MODULE_0___default()('multiCheckbox--controls', { 'body-regular': themeV2 }) },
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("li", { className: "multiCheckbox--control" },
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "address.select" })),
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("li", { className: "multiCheckbox--control" },
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("a", { "data-test": `${testId}Checkbox-all-button`, href: "#", onClick: handleSelectAllClick },
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "address.select_all" }))),
        react__WEBPACK_IMPORTED_MODULE_1___default().createElement("li", { className: "multiCheckbox--control" },
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement("a", { "data-test": `${testId}Checkbox-none-button`, href: "#", onClick: handleSelectNoneClick },
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "address.select_none" })))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react__WEBPACK_IMPORTED_MODULE_1__.memo)(MultiCheckboxControl));
...
const RadioInput = (0,react__WEBPACK_IMPORTED_MODULE_2__.forwardRef)((_a, ref) => {
    var { additionalClassName, label, value, checked, id, themeV2 = false } = _a, rest = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__rest)(_a, ["additionalClassName", "label", "value", "checked", "id", "themeV2"]);
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement((react__WEBPACK_IMPORTED_MODULE_2___default().Fragment), null,
        ...
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_Label_Label__WEBPACK_IMPORTED_MODULE_4__["default"], { additionalClassName: themeV2 ? 'body-regular' : '', htmlFor: id }, label)));
});
