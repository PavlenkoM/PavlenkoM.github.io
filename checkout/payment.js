...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[3].use[2]!./packages/ui/src/modal/ModalLink.scss"
/*!*******************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[3].use[2]!./packages/ui/src/modal/ModalLink.scss ***!
  \*******************************************************************************************************************************************************/
...
var content = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js!../../../../node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[3].use[2]!./ModalLink.scss */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[3].use[2]!./packages/ui/src/modal/ModalLink.scss");
...
const ChequePaymentMethod = (0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(() => __webpack_require__.e(/*! import() | cheque-payment-method */ "cheque-payment-method").then(__webpack_require__.bind(__webpack_require__, /*! @bigcommerce/checkout/cheque-payment-integration */ "./packages/cheque-payment-integration/src/index.ts")).then(module => ({ default: module.ChequePaymentMethod })));
...
/* harmony import */ var _paymentMethod__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./paymentMethod */ "./packages/core/src/app/payment/paymentMethod/PaymentMethodProviderType.ts");
...
/* harmony import */ var _paymentMethodFilters__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./paymentMethodFilters */ "./packages/core/src/app/payment/paymentMethodFilters/getFilteredPaymentMethodsWithDefault.ts");
...
const Payment = (props) => {
    ...
    const disableSubmit = (method, disabled = true) => {
        const uniqueId = (0,_paymentMethod__WEBPACK_IMPORTED_MODULE_29__["default"])(method.id, method.gateway);
    ...
    const handleBeforeUnload = (event) => {
        ...
        if (!isSubmittingOrder ||
            !selectedMethod ||
            selectedMethod.type === _paymentMethod__WEBPACK_IMPORTED_MODULE_28__["default"].Hosted ||
            selectedMethod.type === _paymentMethod__WEBPACK_IMPORTED_MODULE_28__["default"].PPSDK ||
    ...
    const handleSubmit = (0,react__WEBPACK_IMPORTED_MODULE_11__.useCallback)((values) => (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(void 0, void 0, void 0, function* () {
        ...
        const customSubmit = selectedMethod &&
            submitFunctions[(0,_paymentMethod__WEBPACK_IMPORTED_MODULE_29__["default"])(selectedMethod.id, selectedMethod.gateway)];
        if (customSubmit) {
    ...
    const loadPaymentMethodsOrThrow = () => (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const defaultMethod = checkout && config
                ? (0,_paymentMethodFilters__WEBPACK_IMPORTED_MODULE_30__.getFilteredPaymentMethodsWithDefault)({
                    checkout,
    ...
    const uniqueSelectedMethodId = selectedMethod && (0,_paymentMethod__WEBPACK_IMPORTED_MODULE_29__["default"])(selectedMethod.id, selectedMethod.gateway);
...
function mapToPaymentProps({ checkoutService, checkoutState }, { capabilities }) {
    ...
    const { defaultMethod, filteredMethods } = (0,_paymentMethodFilters__WEBPACK_IMPORTED_MODULE_30__.getFilteredPaymentMethodsWithDefault)({
        checkout,
        checkoutSettings: config.checkoutSettings,
        getPaymentMethod,
        methods,
    ...
    return {
        ...
        shouldShowSubmitPaymentButton: (0,_common_utility__WEBPACK_IMPORTED_MODULE_21__["default"])(checkoutSettings, 'CHECKOUT-9729.show_submit_button_when_payment_not_required', false),
...
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/form/contexts/FormContext.tsx");
...
/* harmony import */ var _termsConditions__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../termsConditions */ "./packages/core/src/app/termsConditions/TermsConditions.tsx");
...
/* harmony import */ var _ProvidersSectionOnTopOfPaymentsList__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./ProvidersSectionOnTopOfPaymentsList */ "./packages/core/src/app/payment/ProvidersSectionOnTopOfPaymentsList/ProvidersSectionOnTopOfPaymentsList.tsx");
/* harmony import */ var _SpamProtectionField__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./SpamProtectionField */ "./packages/core/src/app/payment/SpamProtectionField.tsx");
/* harmony import */ var _storeCredit__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./storeCredit */ "./packages/core/src/app/payment/storeCredit/StoreCreditField.tsx");
/* harmony import */ var _storeCredit__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./storeCredit */ "./packages/core/src/app/payment/storeCredit/StoreCreditOverlay.tsx");
...
const PaymentForm = ({ availableStoreCredit = 0, didExceedSpamLimit, isEmbedded, isInitializingPayment, isPaymentDataRequired, isTermsConditionsRequired, isStoreCreditApplied, isUsingMultiShipping, language, methods, onMethodSelect, onStoreCreditChange, onUnhandledError, resetForm, selectedMethod, shouldDisableSubmit, shouldHidePaymentSubmitButton, shouldExecuteSpamCheck, termsConditionsText = '', termsConditionsUrl, usableStoreCredit = 0, values, }) => {
    ...
    const shouldShowSubmitButtonWhenPaymentNotRequired = (0,_common_utility__WEBPACK_IMPORTED_MODULE_11__["default"])(checkoutSettings, 'CHECKOUT-9729.show_submit_button_when_payment_not_required', false);
    const hideSubmitPaymentButton = shouldHidePaymentSubmitButton ||
        (shouldShowSubmitButtonWhenPaymentNotRequired &&
            isPaymentDataRequired() &&
            (0,lodash__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(methods));
    if (shouldExecuteSpamCheck) {
        return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_SpamProtectionField__WEBPACK_IMPORTED_MODULE_22__["default"], { didExceedSpamLimit: didExceedSpamLimit, onUnhandledError: onUnhandledError }));
    }
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_7__["default"], { className: "checkout-form", testId: "payment-form" },
        usableStoreCredit > 0 && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_storeCredit__WEBPACK_IMPORTED_MODULE_23__["default"], { availableStoreCredit: availableStoreCredit, isStoreCreditApplied: isStoreCreditApplied, name: "useStoreCredit", onChange: onStoreCreditChange, usableStoreCredit: usableStoreCredit })),
        shouldShowSubmitButtonWhenPaymentNotRequired &&
            (0,lodash__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(methods) &&
            (isPaymentDataRequired() ? (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_NoPaymentMethods__WEBPACK_IMPORTED_MODULE_14__.NoPaymentMethods, { message: react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_5__["default"], { id: "payment.payment_methods_unavailable_error" }) })) : (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_NoPaymentMethods__WEBPACK_IMPORTED_MODULE_14__.NoPaymentMethods, { message: react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_5__["default"], { id: "payment.payment_not_required_text" }) }))),
        (!shouldShowSubmitButtonWhenPaymentNotRequired || !(0,lodash__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(methods)) && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(PaymentMethodListFieldset, { isEmbedded: isEmbedded, isInitializingPayment: isInitializingPayment, isPaymentDataRequired: isPaymentDataRequired, isUsingMultiShipping: isUsingMultiShipping, methods: methods, onMethodSelect: onMethodSelect, onUnhandledError: onUnhandledError, resetForm: resetForm, values: values })),
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_PaymentRedeemables__WEBPACK_IMPORTED_MODULE_19__["default"], null),
        isTermsConditionsRequired && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_termsConditions__WEBPACK_IMPORTED_MODULE_12__.TermsConditions, { termsConditionsText: termsConditionsText, termsConditionsUrl: termsConditionsUrl })),
...
const PaymentMethodListFieldset = ({ isEmbedded, isInitializingPayment, isPaymentDataRequired, isUsingMultiShipping, methods, onMethodSelect = lodash__WEBPACK_IMPORTED_MODULE_1__.noop, onUnhandledError, resetForm, values, }) => {
    const { setSubmitted } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useContext)(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_8__["default"]);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_9__["default"], { legend: react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_10__["default"], null,
        ...
        !isPaymentDataRequired() && react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_storeCredit__WEBPACK_IMPORTED_MODULE_24__["default"], null),
        ...
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_ProvidersSectionOnTopOfPaymentsList__WEBPACK_IMPORTED_MODULE_21__.ProvidersSectionOnTopOfPaymentsList, { methods: methods }),
...
/* harmony import */ var _cart__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../cart */ "./packages/core/src/app/cart/Redeemable.tsx");
/* harmony import */ var _cart__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../cart */ "./packages/core/src/app/cart/mapToRedeemableProps.ts");
...
const PaymentRedeemables = (redeemableProps) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_3__["default"], { additionalClassName: "redeemable-payments", legend: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_4__["default"], { hidden: true },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "payment.redeemable_payments_text" })) },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_cart__WEBPACK_IMPORTED_MODULE_5__["default"], Object.assign({}, redeemableProps, { showAppliedRedeemables: !isMultiCouponEnabled }))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_checkout__WEBPACK_IMPORTED_MODULE_7__["default"])(_cart__WEBPACK_IMPORTED_MODULE_6__["default"])((0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(PaymentRedeemables)));
...
const PaymentMethodListItem = ({ isDisabled, isEmbedded, isUsingMultiShipping, method, onUnhandledError, value, }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_5__["default"], { content: renderPaymentMethod, htmlId: `radio-${value}`, isDisabled: isDisabled, label: renderPaymentMethodTitle, value: value }));
};
    ...
    return (method) => {
        ...
        const customTitles = {
            ...
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].Afterpay]: {
                logoUrl: (0,_common_utility__WEBPACK_IMPORTED_MODULE_12__["default"])(checkoutSettings, 'PROJECT-6993.change_afterpay_logo_for_us_stores') && storeCountryCode === 'US'
            ...
            [_PaymentMethodType__WEBPACK_IMPORTED_MODULE_18__["default"].Paypal]: {
                ...
                titleText: '',
                subtitle: (props) => {
                    if (method.id === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].BraintreePaypalCredit ||
                        method.id === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].BraintreePaypal) {
        ...
        if (method.gateway === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].WorldpayAccess) {
            if (method.id === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].WorldpayAccessOpenBanking) {
                return { logoUrl: '', titleText: methodDisplayName };
            }
            if (method.id === 'credit_card' || method.id === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].WorldpayAccess) {
                return {
                    logoUrl: '',
        ...
        if (method.id === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].WorldpayAccess) {
...
/* harmony import */ var _excludePPSDKFilter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./excludePPSDKFilter */ "./packages/core/src/app/payment/paymentMethodFilters/excludePPSDKFilter.ts");
...
const FILTERS = [
    ...
    _excludePPSDKFilter__WEBPACK_IMPORTED_MODULE_2__.excludePPSDKFilter,
...
/***/ "./packages/core/src/app/payment/paymentMethodFilters/excludePPSDKFilter.ts"
/*!**********************************************************************************!*\
  !*** ./packages/core/src/app/payment/paymentMethodFilters/excludePPSDKFilter.ts ***!
  \**********************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   excludePPSDKFilter: () => (/* binding */ excludePPSDKFilter)
/* harmony export */ });
/* harmony import */ var _paymentMethod__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../paymentMethod */ "./packages/core/src/app/payment/paymentMethod/PaymentMethodProviderType.ts");

const excludePPSDKFilter = {
    name: 'excludePPSDK',
    apply(methods, { capabilities }) {
        if (!capabilities.payment.excludePPSDK) {
            return methods;
        }
        return methods.filter((method) => method.type !== _paymentMethod__WEBPACK_IMPORTED_MODULE_0__["default"].PPSDK);
    },
};
