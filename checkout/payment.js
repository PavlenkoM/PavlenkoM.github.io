    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { className: "productList-item", "data-test": "cart-stock-positions-changed-item" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "product" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "product-column product-body" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h4", { className: "product-title optimizedCheckout-contentPrimary body-medium", "data-test": "cart-item-product-title" }, item.name),
                item.options && item.options.length > 0 && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", { className: "product-options optimizedCheckout-contentSecondary sub-text-medium", "data-test": "cart-item-product-options" }, item.options.map((option, index) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { className: "product-option", "data-test": "cart-item-product-option", key: index },
                    ...
                    " ",
                    option.value))))),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: "optimizedCheckout-contentSecondary sub-text-medium", "data-test": "cart-item-quantity" },
...
/* harmony import */ var _CartStockPositionsChangedItemList__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./CartStockPositionsChangedItemList */ "./packages/core/src/app/payment/CartStockPositionsChangedItemList.tsx");
/* harmony import */ var _CartStockPositionsChangedMultiConsignmentContent__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./CartStockPositionsChangedMultiConsignmentContent */ "./packages/core/src/app/payment/CartStockPositionsChangedMultiConsignmentContent.tsx");
/* harmony import */ var _cartStockPositionsChangedUtils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./cartStockPositionsChangedUtils */ "./packages/core/src/app/payment/cartStockPositionsChangedUtils.ts");
...
const CartStockPositionsChangedModal = ({ cart, changedLineItemIds, consignments, isOpen, onPlaceOrder, onRequestClose, }) => {
    ...
    const changedItemsToShow = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => (0,_cartStockPositionsChangedUtils__WEBPACK_IMPORTED_MODULE_10__.getChangedItemsToShow)(cart, changedLineItemIds), [cart, changedLineItemIds]);
    const groupedByConsignment = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => (0,_cartStockPositionsChangedUtils__WEBPACK_IMPORTED_MODULE_10__.groupChangedItemsByConsignment)(cart, consignments, changedItemsToShow), [cart, consignments, changedItemsToShow]);
    const modalContent = groupedByConsignment ? (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_CartStockPositionsChangedMultiConsignmentContent__WEBPACK_IMPORTED_MODULE_9__["default"], { consignmentGroups: groupedByConsignment })) : (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_CartStockPositionsChangedItemList__WEBPACK_IMPORTED_MODULE_8__["default"], { items: changedItemsToShow }));
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_ui_modal__WEBPACK_IMPORTED_MODULE_6__["default"], { additionalModalClassName: classnames__WEBPACK_IMPORTED_MODULE_0___default()('cart-stock-positions-changed-modal', {
            themeV2,
        }), footer: react__WEBPACK_IMPORTED_MODULE_1___default().createElement((react__WEBPACK_IMPORTED_MODULE_1___default().Fragment), null,
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_ui_button__WEBPACK_IMPORTED_MODULE_5__["default"], { className: "body-medium", onClick: onRequestClose, variant: _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_4__.ButtonVariant.Secondary },
            ...
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_ui_button__WEBPACK_IMPORTED_MODULE_5__["default"], { className: "body-medium", onClick: onPlaceOrder, variant: _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_4__.ButtonVariant.Primary },
                react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_3__["default"], { id: "payment.place_order_action" }))), header: react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_ui_modal__WEBPACK_IMPORTED_MODULE_7__["default"], { additionalClassName: "header" },
...
const CartStockPositionsChangedMultiConsignmentContent = ({ consignmentGroups, }) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "cart-stock-positions-changed-modal-groups", "data-test": "cart-stock-positions-changed-groups" }, consignmentGroups.map(({ consignment, consignmentNumber, items }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "cart-stock-positions-changed-modal-group", "data-test": "cart-stock-positions-changed-group", key: consignment.id },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", { className: "cart-stock-positions-changed-modal-destination", "data-test": "cart-stock-positions-changed-destination" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_1__["default"], { data: { address, consignmentNumber }, id: "cart.cart_stock_modal_destination" })),
...
/* harmony import */ var _common_error__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../common/error */ "./packages/core/src/app/common/error/isCartStockPositionChangedError.ts");
/* harmony import */ var _common_utility__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../common/utility */ "./packages/core/src/app/common/utility/emptyData.ts");
/* harmony import */ var _common_utility__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../common/utility */ "./packages/core/src/app/common/utility/isExperimentEnabled.ts");
/* harmony import */ var _termsConditions__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../termsConditions */ "./packages/core/src/app/termsConditions/TermsConditionsField.tsx");
/* harmony import */ var _CartStockPositionsChangedModal__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./CartStockPositionsChangedModal */ "./packages/core/src/app/payment/CartStockPositionsChangedModal.tsx");
/* harmony import */ var _mapSubmitOrderErrorMessage__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./mapSubmitOrderErrorMessage */ "./packages/core/src/app/payment/mapSubmitOrderErrorMessage.ts");
/* harmony import */ var _mapToOrderRequestBody__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./mapToOrderRequestBody */ "./packages/core/src/app/payment/mapToOrderRequestBody.ts");
/* harmony import */ var _PaymentContext__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./PaymentContext */ "./packages/core/src/app/payment/PaymentContext.tsx");
/* harmony import */ var _PaymentForm__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./PaymentForm */ "./packages/core/src/app/payment/PaymentForm.tsx");
/* harmony import */ var _paymentMethod__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./paymentMethod */ "./packages/core/src/app/payment/paymentMethod/PaymentMethodId.ts");
/* harmony import */ var _paymentMethod__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./paymentMethod */ "./packages/core/src/app/payment/paymentMethod/PaymentMethodProviderType.ts");
/* harmony import */ var _paymentMethod__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./paymentMethod */ "./packages/core/src/app/payment/paymentMethod/getUniquePaymentMethodId.ts");
...
const getDefaultPaymentMethod = ({ checkout, consignments, getPaymentMethod, methods, paymentProviderCustomer, }) => {
    ...
    if (paymentProviderCustomer === null || paymentProviderCustomer === void 0 ? void 0 : paymentProviderCustomer.stripeLinkAuthenticationState) {
        const stripeUpePaymentMethod = filteredMethods.filter((method) => method.id === 'card' && method.gateway === _paymentMethod__WEBPACK_IMPORTED_MODULE_28__["default"].StripeUPE);
    ...
    filteredMethods = filteredMethods.filter((method) => {
        if (method.id === _paymentMethod__WEBPACK_IMPORTED_MODULE_28__["default"].Bolt && method.initializationData) {
            return Boolean(method.initializationData.showInCheckout);
        }
        return method.id !== _paymentMethod__WEBPACK_IMPORTED_MODULE_28__["default"].BraintreeLocalPaymentMethod;
    });
    if (consignments && consignments.length > 1) {
        const multiShippingIncompatibleMethodIds = [
            _paymentMethod__WEBPACK_IMPORTED_MODULE_28__["default"].AmazonPay,
        ];
    ...
    const selectedPayment = checkout.payments
        ? (0,lodash__WEBPACK_IMPORTED_MODULE_10__.find)(checkout.payments, { providerType: _paymentMethod__WEBPACK_IMPORTED_MODULE_29__["default"].Hosted })
        : undefined;
...
const Payment = (props) => {
    ...
    const renderCartStockPositionsChangedModal = (error) => {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_11___default().createElement(_CartStockPositionsChangedModal__WEBPACK_IMPORTED_MODULE_23__["default"], { cart: cart, changedLineItemIds: changedLineItemIds, consignments: consignments, isOpen: true, onPlaceOrder: onCartStockModalPlaceOrder, onRequestClose: onCartStockModalRequestClose }));
    };
    const renderOrderErrorModal = () => {
        ...
        if ((0,_common_error__WEBPACK_IMPORTED_MODULE_19__["default"])(error)) {
            if (!isCartStockRefreshComplete) {
                return null;
            }
            return renderCartStockPositionsChangedModal(error);
        }
        return (react__WEBPACK_IMPORTED_MODULE_11___default().createElement(_common_error__WEBPACK_IMPORTED_MODULE_16__["default"], { error: error, message: (0,_mapSubmitOrderErrorMessage__WEBPACK_IMPORTED_MODULE_24__["default"])(error, language.translate.bind(language), shouldLocaliseErrorMessages), onClose: handleCloseModal, title: (0,_mapSubmitOrderErrorMessage__WEBPACK_IMPORTED_MODULE_24__.mapSubmitOrderErrorTitle)(error, language.translate.bind(language)) }));
    };
    ...
    const disableSubmit = (method, disabled = true) => {
        const uniqueId = (0,_paymentMethod__WEBPACK_IMPORTED_MODULE_30__["default"])(method.id, method.gateway);
    ...
    const handleBeforeUnload = (event) => {
        ...
        if (!isSubmittingOrder ||
            !selectedMethod ||
            selectedMethod.type === _paymentMethod__WEBPACK_IMPORTED_MODULE_29__["default"].Hosted ||
            selectedMethod.type === _paymentMethod__WEBPACK_IMPORTED_MODULE_29__["default"].PPSDK ||
    ...
    const handleSubmit = (0,react__WEBPACK_IMPORTED_MODULE_11__.useCallback)((values) => (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(void 0, void 0, void 0, function* () {
        ...
        const customSubmit = selectedMethod &&
            submitFunctions[(0,_paymentMethod__WEBPACK_IMPORTED_MODULE_30__["default"])(selectedMethod.id, selectedMethod.gateway)];
        if (customSubmit) {
            return customSubmit(values);
        }
        try {
            const state = yield submitOrder((0,_mapToOrderRequestBody__WEBPACK_IMPORTED_MODULE_25__["default"])(values, isPaymentDataRequired()));
            ...
            if ((0,_common_error__WEBPACK_IMPORTED_MODULE_18__["default"])(error) && error.type === 'missing_shipping_method') {
                const { errorLogger, cart, consignments } = props;
                const consignmentsWithShippingDetails = consignments === null || consignments === void 0 ? void 0 : consignments.map((consignment) => {
                    var _a, _b, _c;
                    return ({
                        consignmentId: consignment.id,
                        availableMethods: (_b = (_a = consignment.availableShippingOptions) === null || _a === void 0 ? void 0 : _a.map((o) => o.id)) !== null && _b !== void 0 ? _b : [],
                        selectedMethod: (_c = consignment.selectedShippingOption) === null || _c === void 0 ? void 0 : _c.id,
                    });
                });
                (_a = errorLogger === null || errorLogger === void 0 ? void 0 : errorLogger.logMessage) === null || _a === void 0 ? void 0 : _a.call(errorLogger, `DataMissingShippingMethod ${cart === null || cart === void 0 ? void 0 : cart.id} - consignments: ${JSON.stringify(consignmentsWithShippingDetails)}`);
            }
    ...
    const loadPaymentMethodsOrThrow = () => (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const methods = updatedState.data.getPaymentMethods() || _common_utility__WEBPACK_IMPORTED_MODULE_20__.EMPTY_ARRAY;
    ...
    const uniqueSelectedMethodId = selectedMethod && (0,_paymentMethod__WEBPACK_IMPORTED_MODULE_30__["default"])(selectedMethod.id, selectedMethod.gateway);
...
function mapToPaymentProps({ checkoutService, checkoutState, }) {
    ...
    const methods = getPaymentMethods() || _common_utility__WEBPACK_IMPORTED_MODULE_20__.EMPTY_ARRAY;
    ...
    return {
        ...
        shouldShowSubmitPaymentButton: (0,_common_utility__WEBPACK_IMPORTED_MODULE_21__["default"])(config.checkoutSettings, 'CHECKOUT-9729.show_submit_button_when_payment_not_required', false),
        submitOrder: checkoutService.submitOrder,
        submitOrderError: getSubmitOrderError(),
        checkoutServiceSubscribe: checkoutService.subscribe,
        termsConditionsText: isTermsConditionsRequired && termsConditionsType === _termsConditions__WEBPACK_IMPORTED_MODULE_22__.TermsConditionsType.TextArea
            ? termsCondtitionsText
            : undefined,
        termsConditionsUrl: isTermsConditionsRequired && termsConditionsType === _termsConditions__WEBPACK_IMPORTED_MODULE_22__.TermsConditionsType.Link
            ? termsCondtitionsUrl
            : undefined,
...
/* harmony import */ var _NoPaymentMethods__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./NoPaymentMethods */ "./packages/core/src/app/payment/NoPaymentMethods.tsx");
/* harmony import */ var _paymentMethod__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./paymentMethod */ "./packages/core/src/app/payment/paymentMethod/PaymentMethodId.ts");
/* harmony import */ var _paymentMethod__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./paymentMethod */ "./packages/core/src/app/payment/paymentMethod/PaymentMethodList.tsx");
/* harmony import */ var _paymentMethod__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./paymentMethod */ "./packages/core/src/app/payment/paymentMethod/getUniquePaymentMethodId.ts");
/* harmony import */ var _paymentMethod__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./paymentMethod */ "./packages/core/src/app/payment/paymentMethod/getPaymentMethodName.ts");
/* harmony import */ var _PaymentRedeemables__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./PaymentRedeemables */ "./packages/core/src/app/payment/PaymentRedeemables.tsx");
/* harmony import */ var _PaymentSubmitButton__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./PaymentSubmitButton */ "./packages/core/src/app/payment/PaymentSubmitButton.tsx");
/* harmony import */ var _SpamProtectionField__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./SpamProtectionField */ "./packages/core/src/app/payment/SpamProtectionField.tsx");
/* harmony import */ var _storeCredit__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./storeCredit */ "./packages/core/src/app/payment/storeCredit/StoreCreditField.tsx");
/* harmony import */ var _storeCredit__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./storeCredit */ "./packages/core/src/app/payment/storeCredit/StoreCreditOverlay.tsx");
...
const PaymentForm = ({ availableStoreCredit = 0, didExceedSpamLimit, isEmbedded, isInitializingPayment, isPaymentDataRequired, isTermsConditionsRequired, isStoreCreditApplied, isUsingMultiShipping, language, methods, onMethodSelect, onStoreCreditChange, onUnhandledError, resetForm, selectedMethod, shouldDisableSubmit, shouldHidePaymentSubmitButton, shouldExecuteSpamCheck, termsConditionsText = '', termsConditionsUrl, usableStoreCredit = 0, values, }) => {
    ...
    const selectedMethodId = (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(() => {
        ...
        switch (selectedMethod.id) {
            case _paymentMethod__WEBPACK_IMPORTED_MODULE_15__["default"].AmazonPay:
    ...
    const shouldShowSubmitButtonWhenPaymentNotRequired = (0,_common_utility__WEBPACK_IMPORTED_MODULE_8__["default"])(checkoutSettings, 'CHECKOUT-9729.show_submit_button_when_payment_not_required', false);
    const hideSubmitPaymentButton = shouldHidePaymentSubmitButton || (shouldShowSubmitButtonWhenPaymentNotRequired && isPaymentDataRequired() && (0,lodash__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(methods));
    if (shouldExecuteSpamCheck) {
        return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_SpamProtectionField__WEBPACK_IMPORTED_MODULE_21__["default"], { didExceedSpamLimit: didExceedSpamLimit, onUnhandledError: onUnhandledError }));
    }
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_ui_form__WEBPACK_IMPORTED_MODULE_11__["default"], { className: "checkout-form", testId: "payment-form" },
        usableStoreCredit > 0 && (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_storeCredit__WEBPACK_IMPORTED_MODULE_22__["default"], { availableStoreCredit: availableStoreCredit, isStoreCreditApplied: isStoreCreditApplied, name: "useStoreCredit", onChange: onStoreCreditChange, usableStoreCredit: usableStoreCredit })),
        shouldShowSubmitButtonWhenPaymentNotRequired && (0,lodash__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(methods) && (isPaymentDataRequired()
            ? react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_NoPaymentMethods__WEBPACK_IMPORTED_MODULE_14__.NoPaymentMethods, { message: react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_5__["default"], { id: "payment.payment_methods_unavailable_error" }) })
            : react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_NoPaymentMethods__WEBPACK_IMPORTED_MODULE_14__.NoPaymentMethods, { message: react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_5__["default"], { id: "payment.payment_not_required_text" }) })),
        (!shouldShowSubmitButtonWhenPaymentNotRequired || !(0,lodash__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(methods)) &&
        ...
        !isMultiCouponEnabled && react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_PaymentRedeemables__WEBPACK_IMPORTED_MODULE_19__["default"], null),
        ...
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "form-actions" }, hideSubmitPaymentButton ? (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(PaymentMethodSubmitButtonContainer, null)) : (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_PaymentSubmitButton__WEBPACK_IMPORTED_MODULE_20__["default"], { brandName: brandName, initialisationStrategyType: selectedMethod && ((_b = selectedMethod.initializationStrategy) === null || _b === void 0 ? void 0 : _b.type), isComplete: !!((_c = selectedMethod === null || selectedMethod === void 0 ? void 0 : selectedMethod.initializationData) === null || _c === void 0 ? void 0 : _c.isComplete), isDisabled: shouldDisableSubmit, methodGateway: selectedMethod && selectedMethod.gateway, methodId: selectedMethodId, methodName: selectedMethod && (0,_paymentMethod__WEBPACK_IMPORTED_MODULE_18__["default"])(language)(selectedMethod), methodType: selectedMethod && selectedMethod.method })))));
};
...
const PaymentMethodListFieldset = ({ isEmbedded, isInitializingPayment, isPaymentDataRequired, isUsingMultiShipping, methods, onMethodSelect = lodash__WEBPACK_IMPORTED_MODULE_1__.noop, onUnhandledError, resetForm, values, }) => {
    ...
    const handlePaymentMethodSelect = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)((method) => {
        const updatedValues = Object.assign(Object.assign({}, values), { ccCustomerCode: '', ccCvv: '', ccDocument: '', customerEmail: '', customerMobile: '', ccExpiry: '', ccName: '', ccNumber: '', instrumentId: '', paymentProviderRadio: (0,_paymentMethod__WEBPACK_IMPORTED_MODULE_17__["default"])(method.id, method.gateway), shouldCreateAccount: true, shouldSaveInstrument: false });
        resetForm({ values: updatedValues });
        setSubmitted(false);
        onMethodSelect(method);
    }, [values, onMethodSelect, resetForm, setSubmitted]);
    return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_ui_form__WEBPACK_IMPORTED_MODULE_10__["default"], { legend: react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_ui_form__WEBPACK_IMPORTED_MODULE_12__["default"], null,
        ...
        !isPaymentDataRequired() && react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_storeCredit__WEBPACK_IMPORTED_MODULE_23__["default"], null),
        ...
        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_paymentMethod__WEBPACK_IMPORTED_MODULE_16__["default"], { isEmbedded: isEmbedded, isInitializingPayment: isInitializingPayment, isUsingMultiShipping: isUsingMultiShipping, methods: methods, onSelect: handlePaymentMethodSelect, onUnhandledError: onUnhandledError })));
};
const paymentFormConfig = {
    mapPropsToValues: ({ defaultGatewayId, defaultMethodId }) => ({
        ...
        ccName: '',
        ccNumber: '',
        paymentProviderRadio: (0,_paymentMethod__WEBPACK_IMPORTED_MODULE_17__["default"])(defaultMethodId, defaultGatewayId),
        instrumentId: '',
    ...
    validationSchema: ({ isPaymentDataRequired, language, isTermsConditionsRequired = false, validationSchema, }) => (0,_getPaymentValidationSchema__WEBPACK_IMPORTED_MODULE_13__["default"])({
...
/* harmony import */ var _ui_icon__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../ui/icon */ "./packages/core/src/app/ui/icon/IconBolt.tsx");
/* harmony import */ var _paymentMethod__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./paymentMethod */ "./packages/core/src/app/payment/paymentMethod/PaymentMethodId.ts");
/* harmony import */ var _paymentMethod__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./paymentMethod */ "./packages/core/src/app/payment/paymentMethod/PaymentMethodType.ts");
/* harmony import */ var _bigcommerce_checkout_contexts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @bigcommerce/checkout/contexts */ "./packages/contexts/src/theme/ThemeContext.tsx");
...
const providersWithCustomClasses = [_paymentMethod__WEBPACK_IMPORTED_MODULE_6__["default"].Bolt];
const PaymentSubmitButtonText = (0,react__WEBPACK_IMPORTED_MODULE_1__.memo)(({ methodId, methodName, methodType, methodGateway, initialisationStrategyType, brandName, isComplete, isPaymentDataRequired, }) => {
    if (!isPaymentDataRequired) {
        return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "payment.place_order_action" });
    }
    if (methodName && initialisationStrategyType === 'none') {
        return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { data: { methodName }, id: "payment.ppsdk_continue_action" });
    }
    if (methodId === _paymentMethod__WEBPACK_IMPORTED_MODULE_6__["default"].AmazonPay) {
        return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "payment.amazonpay_continue_action" });
    }
    if (methodId === _paymentMethod__WEBPACK_IMPORTED_MODULE_6__["default"].Bolt) {
        return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement((react__WEBPACK_IMPORTED_MODULE_1___default().Fragment), null,
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_ui_icon__WEBPACK_IMPORTED_MODULE_5__["default"], { additionalClassName: "payment-submit-button-bolt-icon" }),
            react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "payment.place_order_action" })));
    }
    if (methodGateway === _paymentMethod__WEBPACK_IMPORTED_MODULE_6__["default"].Barclaycard) {
        return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "payment.barclaycard_continue_action" });
    }
    if (methodGateway === _paymentMethod__WEBPACK_IMPORTED_MODULE_6__["default"].BlueSnapV2) {
        return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "payment.bluesnap_v2_continue_action" });
    }
    if (methodType === _paymentMethod__WEBPACK_IMPORTED_MODULE_7__["default"].VisaCheckout) {
        return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "payment.visa_checkout_continue_action" });
    }
    if (methodType === _paymentMethod__WEBPACK_IMPORTED_MODULE_7__["default"].PaypalVenmo ||
        methodId === _paymentMethod__WEBPACK_IMPORTED_MODULE_6__["default"].BraintreeVenmo) {
        return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "payment.paypal_venmo_continue_action" });
    }
    if (methodType === _paymentMethod__WEBPACK_IMPORTED_MODULE_7__["default"].Paypal) {
        const continueActionId = methodId === _paymentMethod__WEBPACK_IMPORTED_MODULE_6__["default"].PaypalCommerce
            ? 'payment.place_order_action'
            : 'payment.paypal_continue_action';
        return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { data: { isComplete }, id: isComplete ? 'payment.paypal_complete_action' : continueActionId });
    }
    if (methodType === _paymentMethod__WEBPACK_IMPORTED_MODULE_7__["default"].PaypalCredit) {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { data: { brandName, isComplete, continueTranslationId, completeTranslationId }, id: isComplete
                ? completeTranslationId
                : continueTranslationId }));
    }
    if (methodId === _paymentMethod__WEBPACK_IMPORTED_MODULE_6__["default"].Quadpay) {
        return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "payment.quadpay_continue_action" });
    }
    if (methodId === _paymentMethod__WEBPACK_IMPORTED_MODULE_6__["default"].Zip) {
        return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "payment.zip_continue_action" });
    }
    if (methodId === _paymentMethod__WEBPACK_IMPORTED_MODULE_6__["default"].Klarna) {
        return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "payment.klarna_continue_action" });
    }
    return react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_2__["default"], { id: "payment.place_order_action" });
});
const PaymentSubmitButton = ({ isDisabled, isInitializing, isSubmitting, isPaymentDataRequired, methodGateway, methodId, methodName, methodType, initialisationStrategyType, brandName, isComplete, }) => {
    const { themeV2 } = (0,_bigcommerce_checkout_contexts__WEBPACK_IMPORTED_MODULE_8__.useThemeContext)();
    return (react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_ui_button__WEBPACK_IMPORTED_MODULE_4__["default"], { className: classnames__WEBPACK_IMPORTED_MODULE_0___default()({
            [`payment-submit-button-${methodId}`]: providersWithCustomClasses.includes(methodId)
        }, 'sub-header'), "data-test": "payment-submit-button", disabled: isInitializing || isSubmitting || isDisabled, id: "checkout-payment-continue", isFullWidth: true, isLoading: isSubmitting, size: _ui_button__WEBPACK_IMPORTED_MODULE_4__.ButtonSize.Large, type: "submit", variant: themeV2 ? _ui_button__WEBPACK_IMPORTED_MODULE_4__.ButtonVariant.Primary : _ui_button__WEBPACK_IMPORTED_MODULE_4__.ButtonVariant.Action },
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_checkout__WEBPACK_IMPORTED_MODULE_3__["default"])(({ checkoutState }) => {
...
function getChangedItemsToShow(cart, changedLineItemIds) {
    ...
    return (0,lodash__WEBPACK_IMPORTED_MODULE_0__.uniqBy)((0,lodash__WEBPACK_IMPORTED_MODULE_0__.compact)(changedLineItemIds.map((id) => {
        ...
        if (!item)
            return undefined;
        return item.parentId != null ? ((_a = allCartPhysicalItemsById.get(item.parentId)) !== null && _a !== void 0 ? _a : item) : item;
    })), 'id');
}
/**
...
/* harmony import */ var _bigcommerce_checkout_paypal_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @bigcommerce/checkout/paypal-utils */ "./packages/paypal-utils/src/PaypalCommerceCreditBanner.tsx");
/* harmony import */ var _bigcommerce_checkout_paypal_utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @bigcommerce/checkout/paypal-utils */ "./packages/paypal-utils/src/BraintreePaypalCreditBanner.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/icon/CreditCardIconList.tsx");
/* harmony import */ var _bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @bigcommerce/checkout/ui */ "./packages/ui/src/icon/mapFromPaymentMethodCardType.ts");
/* harmony import */ var _checkout__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../checkout */ "./packages/core/src/app/checkout/withCheckout.tsx");
/* harmony import */ var _common_form__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../common/form */ "./packages/core/src/app/common/form/connectFormik.tsx");
/* harmony import */ var _common_utility__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../common/utility */ "./packages/core/src/app/common/utility/isExperimentEnabled.ts");
/* harmony import */ var _CreditCardFieldsetValues__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./CreditCardFieldsetValues */ "./packages/core/src/app/payment/paymentMethod/CreditCardFieldsetValues.ts");
/* harmony import */ var _getPaymentMethodDisplayName__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./getPaymentMethodDisplayName */ "./packages/core/src/app/payment/paymentMethod/getPaymentMethodDisplayName.tsx");
/* harmony import */ var _getPaymentMethodName__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./getPaymentMethodName */ "./packages/core/src/app/payment/paymentMethod/getPaymentMethodName.ts");
/* harmony import */ var _HostedCreditCardFieldsetValues__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./HostedCreditCardFieldsetValues */ "./packages/core/src/app/payment/paymentMethod/HostedCreditCardFieldsetValues.ts");
/* harmony import */ var _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./PaymentMethodId */ "./packages/core/src/app/payment/paymentMethod/PaymentMethodId.ts");
/* harmony import */ var _PaymentMethodType__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./PaymentMethodType */ "./packages/core/src/app/payment/paymentMethod/PaymentMethodType.ts");
...
function getPaymentMethodTitle(language, basePath, checkoutSettings, storeCountryCode) {
    ...
    return (method) => {
        ...
        const paymentWithLogo = ((_a = method.initializationData) === null || _a === void 0 ? void 0 : _a.methodsWithLogo)
            ...
            : [];
        const methodName = (0,_getPaymentMethodName__WEBPACK_IMPORTED_MODULE_15__["default"])(language)(method);
        const methodDisplayName = (0,_getPaymentMethodDisplayName__WEBPACK_IMPORTED_MODULE_14__["default"])(language)(method);
        ...
        const customTitles = {
            [_PaymentMethodType__WEBPACK_IMPORTED_MODULE_18__["default"].CreditCard]: {
                logoUrl: '',
                titleText: methodName,
            },
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].BraintreeVenmo]: {
                logoUrl: method.logoUrl || '',
                titleText: method.logoUrl ? '' : methodDisplayName,
            },
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].BraintreePaypalCredit]: {
                logoUrl: cdnPath('/img/payment-providers/paypal_commerce_logo_letter.svg'),
                titleText: methodDisplayName,
                subtitle: (props) => (react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_bigcommerce_checkout_paypal_utils__WEBPACK_IMPORTED_MODULE_7__["default"], Object.assign({ containerId: 'braintree-credit-banner-container' }, props))),
            },
            [_PaymentMethodType__WEBPACK_IMPORTED_MODULE_18__["default"].PaypalCredit]: {
                logoUrl: cdnPath('/img/payment-providers/paypal_commerce_logo_letter.svg'),
                titleText: methodDisplayName,
            },
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].BraintreeAch]: {
                logoUrl: method.logoUrl || '',
                titleText: methodDisplayName,
            },
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].BraintreeLocalPaymentMethod]: {
                logoUrl: method.logoUrl || '',
                titleText: methodDisplayName,
            },
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].BigCommercePaymentsPayPal]: {
            ...
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].BigCommercePaymentsPayLater]: {
                logoUrl: cdnPath('/img/payment-providers/paypal_commerce_logo_letter.svg'),
                titleText: methodDisplayName,
            ...
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].BigCommercePaymentsAlternativeMethod]: {
                logoUrl: method.logoUrl || '',
                titleText: method.logoUrl ? '' : methodDisplayName,
            },
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].PaypalCommerce]: {
                logoUrl: cdnPath('/img/payment-providers/paypal_commerce_logo.svg'),
                titleText: '',
                subtitle: (props) => react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_bigcommerce_checkout_paypal_utils__WEBPACK_IMPORTED_MODULE_6__["default"], Object.assign({ containerId: 'paypal-commerce-banner-container' }, props))
            },
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].PaypalCommerceCredit]: {
                logoUrl: cdnPath('/img/payment-providers/paypal_commerce_logo_letter.svg'),
                titleText: methodDisplayName,
                subtitle: (props) => react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_bigcommerce_checkout_paypal_utils__WEBPACK_IMPORTED_MODULE_6__["default"], Object.assign({ containerId: 'paypal-commerce-credit-banner-container' }, props))
            },
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].PaypalCommerceAlternativeMethod]: {
                logoUrl: method.logoUrl || '',
                titleText: method.logoUrl ? '' : methodDisplayName,
            },
            [_PaymentMethodType__WEBPACK_IMPORTED_MODULE_18__["default"].VisaCheckout]: {
                logoUrl: cdnPath('/img/payment-providers/visa-checkout.png'),
                titleText: methodName,
            },
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].Affirm]: {
            ...
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].Afterpay]: {
                logoUrl: (0,_common_utility__WEBPACK_IMPORTED_MODULE_12__["default"])(checkoutSettings, 'PROJECT-6993.change_afterpay_logo_for_us_stores') && storeCountryCode === 'US' ? cdnPath('/img/payment-providers/afterpay-new-us.svg') : cdnPath('/img/payment-providers/afterpay-badge-blackonmint.png'),
                titleText: methodName,
            },
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].AmazonPay]: {
                logoUrl: cdnPath('/img/payment-providers/amazon-header.png'),
                titleText: '',
            },
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].ApplePay]: {
                logoUrl: cdnPath('/modules/checkout/applepay/images/applepay-header@2x.png'),
                titleText: '',
            },
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].Bolt]: {
                logoUrl: '',
                titleText: methodDisplayName,
            },
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].Clearpay]: {
                logoUrl: cdnPath('/img/payment-providers/clearpay-header.png'),
                titleText: '',
            },
            [_PaymentMethodType__WEBPACK_IMPORTED_MODULE_18__["default"].GooglePay]: {
                logoUrl: cdnPath('/img/payment-providers/google-pay.png'),
                titleText: '',
            },
            [_PaymentMethodType__WEBPACK_IMPORTED_MODULE_18__["default"].PayWithGoogle]: {
                logoUrl: cdnPath('/img/payment-providers/google-pay.png'),
                titleText: '',
            },
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].Humm]: {
                logoUrl: cdnPath('/img/payment-providers/humm-checkout-header.png'),
                titleText: '',
            },
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].Klarna]: {
            ...
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].Laybuy]: {
                logoUrl: cdnPath('/img/payment-providers/laybuy-checkout-header.png'),
                titleText: '',
            },
            [_PaymentMethodType__WEBPACK_IMPORTED_MODULE_18__["default"].Paypal]: {
                ...
                logoUrl: method.id === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].BraintreeVenmo && method.logoUrl
                    ? method.logoUrl
                    : cdnPath('/img/payment-providers/paypalpaymentsprouk.png'),
                titleText: '',
                subtitle: (props) => {
                    if ((0,_common_utility__WEBPACK_IMPORTED_MODULE_12__["default"])(checkoutSettings, 'CHECKOUT-9450.lazy_load_payment_strategies', false)) {
                        if (method.id === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].BraintreePaypalCredit || method.id === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].BraintreePaypal) {
                            return react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_bigcommerce_checkout_paypal_utils__WEBPACK_IMPORTED_MODULE_7__["default"], Object.assign({ containerId: 'braintree-banner-container' }, props));
                        }
                        return null;
                    }
                    return react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_bigcommerce_checkout_paypal_utils__WEBPACK_IMPORTED_MODULE_7__["default"], Object.assign({ containerId: 'braintree-banner-container' }, props));
            ...
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].Quadpay]: {
                logoUrl: cdnPath('/img/payment-providers/quadpay.png'),
                titleText: language.translate('payment.quadpay_display_name_text'),
            },
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].Sezzle]: {
            ...
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].StripeV3]: {
            ...
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].StripeUPE]: {
                logoUrl: paymentWithLogo.includes(method.id)
                    ? cdnPath(`/img/payment-providers/stripe-${method.id.toLowerCase()}.svg`)
                    : '',
                titleText: method.method === 'iban'
            ...
            [_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].WorldpayAccess]: {
                logoUrl: '',
                titleText: language.translate('payment.credit_debit_card_text'),
            },
        };
        if (method.gateway === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].BlueSnapDirect) {
        ...
        if (method.id === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].PaypalCommerceVenmo) {
            return customTitles[_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].PaypalCommerceAlternativeMethod];
        }
        if (method.gateway === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].BigCommercePaymentsAlternativeMethod &&
            method.id === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].Klarna) {
            return {
                logoUrl: cdnPath('/img/payment-providers/klarna.png'),
                titleText: methodDisplayName,
            };
        }
        if (method.id === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].BigCommercePaymentsVenmo) {
            return customTitles[_PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].BigCommercePaymentsAlternativeMethod];
        }
        ...
        if (method.id === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].PaypalPaymentsPro &&
            method.method === _PaymentMethodType__WEBPACK_IMPORTED_MODULE_18__["default"].CreditCard) {
            return customTitles[_PaymentMethodType__WEBPACK_IMPORTED_MODULE_18__["default"].CreditCard];
        }
        if (method.id === _PaymentMethodId__WEBPACK_IMPORTED_MODULE_17__["default"].Ratepay) {
        ...
        return (customTitles[method.gateway || ''] ||
            ...
            customTitles[_PaymentMethodType__WEBPACK_IMPORTED_MODULE_18__["default"].CreditCard]);
    };
}
...
const PaymentMethodTitle = ({ cdnBasePath, checkoutSettings, storeCountryCode, onUnhandledError, formik: { values }, instruments, isSelected, language, method }) => {
    ...
    const getSelectedCardType = () => {
        ...
        if ((0,_HostedCreditCardFieldsetValues__WEBPACK_IMPORTED_MODULE_16__.isHostedCreditCardFieldsetValues)(values) && values.hostedForm.cardType) {
            return values.hostedForm.cardType;
        }
        if ((0,_CreditCardFieldsetValues__WEBPACK_IMPORTED_MODULE_13__.hasCreditCardNumber)(values) && values.ccNumber) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('paymentProviderHeader-container', { 'paymentProviderHeader-container-googlePay': method.id.includes('googlepay') }) },
        ...
        react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", { className: "paymentProviderHeader-cc" },
            react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_8__["default"], { cardTypes: (0,lodash__WEBPACK_IMPORTED_MODULE_2__.compact)(method.supportedCards.map(_bigcommerce_checkout_ui__WEBPACK_IMPORTED_MODULE_9__["default"])), selectedCardType: getSelectedCardType() }))));
};
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_common_form__WEBPACK_IMPORTED_MODULE_11__["default"])((0,_bigcommerce_checkout_locale__WEBPACK_IMPORTED_MODULE_5__["default"])((0,_checkout__WEBPACK_IMPORTED_MODULE_10__["default"])(mapToCheckoutProps)((0,react__WEBPACK_IMPORTED_MODULE_3__.memo)(PaymentMethodTitle)))));
